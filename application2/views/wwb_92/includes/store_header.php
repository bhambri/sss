...
<!--tabs-->
  <!--poppup--> 
  <link rel="stylesheet" href="<?php echo store_fallback_path('store/popup/css/colorbox.css') ;?>" type="text/css"/>
...
<!-- start header-->
	<div id="header">
		...
		<div id="main_nav">
			<ul>
				<li><a href="<?php echo base_url() ; ?>home" <?php if(in_array($segs[1],array('home'))){?>class="active"<?php } ?>>Home</a></li>
				<li><a href="<?php echo base_url() ; ?>company-profile" <?php if(in_array($segs[1],array('company-profile','culture','executive_team','policies_procedures'))){?>class="active"<?php } ?>>Company</a></li>
				<li><a href="<?php echo base_url() ; ?>products-power" <?php if(in_array($segs[1],array('products-power','products-passion','atcost-bullion','numismatic-coins'))){?>class="active"<?php } ?>>Products</a></li>
				<li><a href="<?php echo base_url() ; ?>services" <?php if(in_array($segs[1],array('services','theft_service','tax_service'))){?>class="active"<?php } ?>>Services</a></li>
				<li><a href="<?php echo base_url() ; ?>opportunity" <?php if(in_array($segs[1],array('opportunity','recognition','compensation-plan'))){?>class="active"<?php } ?>>Opportunity</a></li>
				<li><a href="<?php echo base_url() ; ?>contact-us" <?php if(in_array($segs[1],array('contact-us'))){?>class="active"<?php } ?>>Contact Us</a></li>
...
<li><a href="<?php echo base_url() ; ?>store/products">Shop Now</a></li>
  ...
  <span class="account-dropdown">       
    <a href="<?php echo base_url()  . 'user/myorders';?>"> My orders</a><br/>
   <a href="<?php echo base_url()  . 'user/account';?>"> Account Info</a><br/>
    <a href="<?php echo base_url()  . 'user/changepassword';?>">Change Password</a><br/>
   <a href="<?php echo base_url()  . 'user/mywishlist';?>"> My wishlist</a><br/>
  </span>
  	    </span>
  	    	 <?php 
                if( isset( $storeUserSession ) && !empty( $storeUserSession ) && is_array( $storeUserSession ) )
    ...
    <span class="login"> 
     ...
     <div class="right-top">
            <div class="navigation" id="menu">  
             ...
             <li><a href="<?php echo base_url() ; ?>store/product">Shop</a>
             ...
             <li><a href="<?php echo base_url();?>become-stylist">Become a Stylist</a></li>
             <li><a href="<?php echo base_url();?>host-a-party">Host a Party</a></li>
  ...
  <span class="mobile-txt">Menu</span>
    ...
    <ul class="clearfix">
            ...
            ?>
             ...
             <li><a href="<?php echo base_url();?>host-a-party">Host a Party</a></li>
             <li><a href="<?php echo base_url();?>about-us">About Us</a></li>
             <li><a href="https://joncarjewelry.net/blog">Blog</a></li>
              </ul>
...
if((count($arrd) > 1) && (!in_array($arrd[1] ,array('/','home','news')))){ ?>
