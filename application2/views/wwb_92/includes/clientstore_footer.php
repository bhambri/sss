...
<div class="footer">
  <div class="footer_left">
    <ul>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/home">Home</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/company-profile">Company</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/products-power">Products</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/opportunity">Opportunity</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/contact-us">Contact Us</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/store/products">Shop Now</a></li>
          <li><a href="<?php echo base_url().'/'.$segsments[1]; ?>/news">News</a></li>
        </ul>
        <ul>
  ...
  <div id='inline_content' style='background:#fff;' class='create-account'>
         <h2>Choose your membership type</h2>
          <div class="register-consultant"> 
            ...
            <div class="btn"><a href="<?php echo base_url() .'/'.$segsments[1]; ?>/user/consultant"><input type="button" value="Sign up today"/></a></div>
         ...
         <div class="register-user">     
           ...
           <ul>             
            ...
            <div class="btn"><a href="<?php echo base_url().'/'.$segsments[1]; ?>/user/register"><input type="button" value="Sign up today"/></a></div>                    
          </div>        
      </div>
    </div>
</body>
