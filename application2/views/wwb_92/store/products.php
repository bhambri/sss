        ...
        <div class="con-inner">
            <div class="inner-txt">
              ...
              <h2>Categories</h2>
                    <div id="toggle-view">
                    <ul>
                    <li><h5><a href="<?php echo base_url()?>store">All</a></h5></li>
                     <?php  
                         ...
                         <div class="panel">
                          <?php 
                              if( isset( $categories['subcategory'] ) && !empty( $categories['subcategory'] ) )
                              {
                                 ...
                                 {                                    
                           ?>          
                              <a href="<?php echo base_url(); ?>store/cat_id/<?php echo $categories['id'].'/'.$subcategory->id;?>"     <?php if(strtolower($this->uri->uri_string) == strtolower('/store/cat_id/'.$categories['id'].'/'.$subcategory->id )){ echo ' class=menuselected '; $selCategory = $categories['name']; $selsubCategory = $subcategory->name ;} ?> > <?php echo $subcategory->name;?></a>
                            <?php 
                               }  
                              }
                            ?>    
         ...
         <a href="/uploads/joncarjewelry/CatalogALL2015.pdf"><img src="<?php echo store_fallback_path('store/images/jew2.png')?>" alt="" class="no-mar" /></a></div> -->
               ...
               <div class="<?php echo $viewclass ;?>">
                <?php 
                  if( isset($products) && is_array( $products ) )
                  {
                     ...
                     if($viewclass != 'all-products-list'){ // 258 //300
                         //$settings = array('w'=>238,'h'=>230,'crop'=>true);
			 $settings = array('w'=>238,'h'=>258,'crop'=>false);
                      }else{
                         $settings = array('w'=>235,'h'=>230,'crop'=>false);
                      }
                     ...
                     if( !empty($pimage))
                      {
                        ...
                        {
                            /* if($viewclass != 'all-products-list'){
                              $settings = array('w'=>230,'h'=>442,'crop'=>true);
                            }else{
          ...
          $image = store_fallback_path('store/images/no-images.jpg') ;
            ...
            //$image = site_url().$product->image;
                ...
                <div class="product <?php echo $class;?>">
                   ...
                   <div class="img">
                    <a href="<?php echo base_url(); ?>store/productDetail/<?php echo $product->id; ?>">
                    <img src="<?php echo $image; ?>" alt="" />
                    </a>
                    <div class="showdiv">
                    <span class="buy">
                    <a href="javascript:void(0);"  onclick="addtocart('<?php echo base_url(); ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/cart-ico.png')?>" alt=""/> Add To Cart</a><br/>
                  
                    <a href="javascript:void(0);" onclick="addtowishlist('<?php echo base_url(); ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/wishlist-ico1.png')?>" alt=""/> Add To Wishlist</a><br/>
                    </span>
                     <span class="quick"><a href="<?php echo base_url(); ?>store/productDetail/<?php echo $product->id; ?>">
                     View</a></span>
                     </div>
...
<span class="cart"> <a href="javascript:void(0);"  onclick="addtocart('<?php echo base_url(); ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/cart-ico.png')?>" alt=""/> Add To Cart</a></span>
                  
    <span class="wish"><a href="javascript:void(0);" onclick="addtowishlist('<?php echo base_url(); ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/wishlist-ico1.png')?>" alt=""/> Add To Wishlist</a></span>            <!-- <a href="javascript:void(0)" ; onclick="addtocart('<?php echo base_url() .  $this->storename; ?>' ,'<?php echo $product->id; ?>');">
                     Buy</a></span>--> 
                    </span>
                     <span class="quick"><a href="<?php echo base_url(); ?>store/productDetail/<?php echo $product->id; ?>">
                     View</a></span></div>
