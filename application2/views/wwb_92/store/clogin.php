 ...
 <div class="con">
    <div class="con-inner">
        <div class="inner-txt">
				...
				<div class="txt"><a href="<?php echo base_url().$this->uri->segment(1); ?>/user/forgot_password">Forgot password?</a> </div>		
				</div>
				...
				<div class="register-btn">
					<span class="stylist"><a href="<?php echo base_url().$this->uri->segment(1); ?>/user/consultant">Register as a <?php echo $this->consultant_label ;?></a></span>
