...
<div class="inner-banner">
    <div class="inner-banner-main">
     <h2>Products Details</h2>
      ...
      <div class="breadcrumb"><a href="<?php echo base_url().'store'?>">Home </a> / Products Details</div>
</div>
<!--banner-->
<div class="con">
  <div class="con-inner">
    ...
    <div class="inner-txt">
      <div class="singleproduct">
		  ...
		  #var_dump(file_get_contents($full_image));
                  if( !empty( $product_detail['image'] )  && file_get_contents($full_image) && (file_get_contents($full_image) !='<h1>Invalid store URL</h1>') && (site_url() != $full_image) )
                  {
                      #echo 'block one';
		      $full_image = site_url().$product_detail['image'];
                      //$settings = array('w'=>450,'h'=>537,'crop'=>true); // commented on 27032015
    ...
    <div class="right-details">
          ...
          <?php
          $sizeArr = explode(',',$product_detail['product_size']) ;
          ?>
