<!-- start: content -->
		...
		<div id="home_contnet">
			...
			<a href="<?php echo base_url() .  $this->storename; ?>/numismatic-coins">
			...
			<div class="cost_home home-box">
				<a href="<?php echo base_url() .  $this->storename; ?>/atcost-bullion">
			...
			<div class="power_home home-box">
				<a href="<?php echo base_url() .  $this->storename; ?>/products-power">
