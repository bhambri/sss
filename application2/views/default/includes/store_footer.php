...
//pr($this) ;
			...
			?>
			<li><a href="<?php echo $this->store_opportunity_link ? $this->store_opportunity_link : base_url().'home#' ; ?>" target="_blank">Opportunities</a></li>
			<li><a href="<?php echo $this->store_about_us_link ? $this->store_about_us_link : base_url().'home#' ;  ?>" target="_blank">About us</a></li>
			<li><a href="<?php echo base_url() ; ?>store/products">Store</a></li>
       ...
       <div class="thr">
        <h2>My account</h2>
	      <ul>
			...
			<li><a href="<?php echo base_url();?>store/products">My store</a></li>
...
<div class="payment-strip"><a href="#"><img src="<?php echo store_fallback_path('store/images/ico-payment.png')?>" alt=""/></a></div>
		...
		<div class="copy">Copyright &copy; <?php echo date('Y') ; ?> simplesalessystems.com. All rights reserved. &nbsp; | &nbsp; <!-- <a href="privacy.php">Privacy Policy</a>  &nbsp;  | --> &nbsp;  <a href="<?php echo base_url().'t_n_c' ?>" target="_blank" >Terms of use</a></div>
		<div class="social">
		<?php 
