...
$product_url = site_url().$segs[1].'/'.$segs[2].'/'.$segs[3] ;
?>
<!--banner-->
<div class="inner-banner">
    <div class="inner-banner-main">
     <h2>Products Details</h2>
      ...
      <div class="breadcrumb"><a href="<?php echo base_url().'home'?>">Home </a> / Products Details</div>       
...
<div class="con">
  <div class="con-inner">
    ...
    <div class="right-details">
          ...
          ?>
           <form action="<?php echo site_url(); ?>cart/add" method="POST" id="formID">
           <?php if($sizeArr[0] !="" ){ ?>
           <div class="size">
             <div class="selectimg">
             <select name="size">
