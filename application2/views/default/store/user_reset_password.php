 <!--banner-->
 	  <div class="inner-banner">
         ...
         <h2>Reset Password</h2>
 	  	   ...
 	  	   <div class="breadcrumb"><a href="<?php echo base_url().'home'?>">Home</a> / Reset Password</div>
 	  </div>
        ...
        <div class="con-inner">
            <div class="inner-txt">
               ...
               <div class="registration-details">
			    ...
			    <?php echo form_open('/user/reset_password',array('id'=>'resetPassword','name'=>'resetPassword'));?>     
				<div class="form">
					<div class="fld">
					...
					<div class="fld">
						<input type="hidden" name="user_id" value="<?php echo base64_decode(trim($this->uri->segment(3))); ?>" />
