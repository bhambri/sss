...
<div class="inner-banner">
  <div class="inner-banner-main">
 	...
 	<div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segments[1].'/home' ;?>">Home </a> / Checkout</div>
</div>
<!--banner-->
<div class="con">
  <div class="con-inner">
    ...
    <div class="inner-txt">  
      ...
      <div class="cart-form">
            ...
            <?php  $billing_state_code =  isset($billing_data['state_code']) ? $billing_data['state_code'] : ''; ?>
              <div class="fld-left">
                 First Name<span class="star">*</span> 
                  <input type="text" name="billing_first_name" class="inp" id="billing_first_name" value="<?php echo set_value('billing_first_name', isset($billing_data['first_name']) ? $billing_data['first_name'] : ''); ?>">
              </div> 
              ...
              <div class="fld-right">
               Phone<span class="star">*</span> 
                  <input type="text" id="billing_phone" name="billing_phone" class="inp" value="<?php echo set_value('billing_phone', isset($billing_data['phone_number']) ? $billing_data['phone_number'] : ''); ?>" maxlength="15">
              </div> 
              <div class="fld-left">
                Address<span class="star">*</span> 
                  <input type="text" id="billing_address" name="billing_address" class="inp" value="<?php echo set_value('billing_address', isset($billing_data['last_name']) ? $billing_data['last_name'] : ''); ?>">
              </div> 
              <div class="fld-right">
                 Town/City<span class="star">*</span> 
                  <input type="text" id="billing_city" name="billing_city" class="inp" value="<?php echo set_value('billing_city', isset($billing_data['city']) ? $billing_data['city'] : ''); ?>">
              </div> 
              <div class="fld-left">
               Email Address<span class="star">*</span> 
                  <input type="text" id="billing_email" class="inp" name="billing_email" value="<?php echo set_value('billing_email', isset($billing_data['email']) ? $billing_data['email'] : ''); ?>">
              </div>               
              <div class="fld-right">
               Zipocode<span class="star">*</span> 
                  <input type="text" id="billing_postal_code" name="billing_postal_code" class="inp" value="<?php echo set_value('billing_postal_code', isset($billing_data['postal_code']) ? $billing_data['postal_code'] : ''); ?>">
              </div> 
        </div>
        ...
        <h5>Shipping Details (Same as billing detail )<input type="checkbox" name="same_as_billing" id="same_as_billing" onclick="sameasbilling(this);"> </input></h5>          
              <div class="fld-left">
                 First Name<span class="star">*</span> 
                  <input type="text" id="shipping_first_name" name="shipping_first_name" class="inp" value="<?php echo set_value('shipping_first_name', isset($shipping_data['first_name']) ? $shipping_data['first_name'] : ''); ?>">
              </div> 
              
              <div class="fld-right">
                 Last Name<span class="star">*</span> 
                  <input type="text" id="shipping_last_name" name="shipping_last_name" class="inp" value="<?php echo set_value('shipping_last_name', isset($shipping_data['last_name']) ? $shipping_data['last_name'] : ''); ?>">
              </div>
              ...
              <div class="fld-right">
               Phone<span class="star">*</span> 
                  <input type="text" name="shipping_phone" id="shipping_phone" class="inp" value="<?php echo set_value('shipping_phone', isset($shipping_data['phone_number']) ? $shipping_data['phone_number'] : ''); ?>" maxlength="15">
              </div> 
              <div class="fld-left">
                Address<span class="star">*</span> 
                  <input type="text" name="shipping_address" id="shipping_address" class="inp" value="<?php echo set_value('shipping_address', isset($shipping_data['address']) ? $shipping_data['address'] : ''); ?>">
              </div> 
              <div class="fld-right">
                 Town/City<span class="star">*</span> 
                  <input type="text" name="shipping_city" id="shipping_city" class="inp" value="<?php echo set_value('shipping_city', isset($shipping_data['city']) ? $shipping_data['city'] : ''); ?>" onchange="calculatetax();" />
              </div> 
              <div class="fld-left">
               Email Address<span class="star">*</span> 
              ...
              <div class="fld-right">
               Zipcode<span class="star">*</span> 
                  <input type="text" name="shipping_postal_code" id="shipping_postal_code" class="inp" value="<?php echo set_value('shipping_postal_code', isset($shipping_data['postal_code']) ? $shipping_data['postal_code'] : ''); ?>" onchange="calculatetax();" />
              </div>
        </div>
      </div>                         
      <div class="order-total-summary">
        ...
        ?>
          ...
          <div class="sub-total">
             Tax  <span class="item-total-red" style="text-decoration:none;">$ <span id="tax" style="text-decoration:none;" class="item-total-red"><?php echo money_format('%.2n',$tax) ; ?></span></span>
          </div>
        	<div class="shipping">
          ...
          <input id="discount_amount" type="hidden" value="<?php echo $discountprice ; ?>"/> 
             ...
             Total <span id="totalPrice">$ <?php echo money_format('%.2n',$grand_total + $shipping_cost - $discountprice ) ;//$this->cart->format_number($this->cart->total()); ?></span>	 
...
<script>
  ...
  function calculateshipping(){
      var nationality = jQuery("select[name='shipping_state_code']").val() ;
        var baseurl = '<?php echo base_url();?>'+'cart/changeshipping' ;
        jQuery.ajax({
          url:baseurl,
