          ...
          <div class="cartproduct">            	 	
            ...
            <div class="right-details">
                ...
                <div class="sizes cart-page-option">
                  ...
                  ?>
                  <?php if(!$required){ ?><a href="<?php echo base_url().$conSeg.'/cart/removeopt/'.$key.'/'.$currentCart['rowid'] ;?>">Remove</a> | <?php } ?>
                  <?php
                   // echo $value ;
                  }
                }
                  ...
                  <!-- <span class="size-qty text-bold">Size </span>text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment, -->
    	   	   	   ...
    	   	   	   <div class="share-item">
        	   	   	 ...
        	   	   	 <div class="remove">   		            	   	   	 
        	   	      <a id="removeItem" href="<?php echo site_url().$conSeg.'/cart/removeitem/'.$currentCart['rowid'] ; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img src="<?php echo store_fallback_path('store/images/remove.png')?>" alt="" title="Remove from bag" class="vtip"/></a>
                   </div>
                </div>
            </div>
          </div>
          ...
          <div class="order-total-summary">     
            ...
            <!-- <input type="hidden" name="tax" id="tax" value="<?php echo $tax; ?>"> -->
               ...
               <div class="placeorder">
                  <div class="continue-btn"><a href="<?php echo site_url().$conSeg; ?>/store/" class="btn"> Continue Shopping</a></div>
                  <form action="<?php echo site_url().$conSeg; ?>/cart/checkout" method="get"> 
