    ...
    <div class="inner-txt">  
      ...
      <div class="cart-form">
        ...
        <h5>Shipping Details (Same as billing detail )<input type="checkbox" name="same_as_billing" id="same_as_billing" onclick="sameasbilling(this);"> </input></h5>          
              ...
              <div class="fld-right">
                 Town/City<span class="star">*</span> 
                  <input type="text" name="shipping_city" class="inp"  id="shipping_city"  value="<?php echo set_value('shipping_city', isset($shipping_data['city']) ? $shipping_data['city'] : ''); ?>" onchange="calculatetax();" />
              </div> 
              <div class="fld-left">
               Email Address<span class="star">*</span> 
      ...
      <div class="order-total-summary">
        ...
        ?>
          ...
          <?php 
          		$discountprice = 0 ;
          		//if(! empty($this->session->userdata('coupon_data'))){
              if($this->session->userdata('coupon_data')){
          		#echo '<pre>'; #print_r($this->session->userdata('coupon_data')) ;
