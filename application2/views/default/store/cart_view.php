...
<div class="inner-banner">
 ...
 <h2>cart</h2>
  ...
  <div class="breadcrumb"><a href="<?php echo base_url().'home'?>">Home </a>/ Cart</div>
</div>
<!--banner-->
        ...
        <div class="sizes cart-page-option">
          ...
          <!-- <span class="size-qty text-bold">Size </span>text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment, -->
 	   	   ...
 	   	   <div class="share-item">
	   	   	 ...
	   	   	 <!-- <div class="remove"><img src="<?php echo store_fallback_path('store/')?>images/remove.png" alt="" title="Remove from bag" class="vtip"/></div>  -->
           <div class="remove">                              
            <a id="removeItem" href="<?php echo site_url().'cart/removeitem/'.$currentCart['rowid'] ; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img src="<?php echo store_fallback_path('store/images/remove.png')?>" alt="" title="Remove from bag" class="vtip"/></a>
           </div>     		            	   	   	 
  	   	</div>
	   </div>
  	</div>
