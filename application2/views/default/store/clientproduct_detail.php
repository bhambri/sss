...
<!--banner-->
    <div class="inner-banner">
        <div class="inner-banner-main">
         ...
         <div class="breadcrumb"><a href="<?php echo base_url() .$this->uri->segments[1].'/home'?>">Home </a> / Products Details</div>       
    </div>
    <!--banner-->
     <div class="con">
        <div class="con-inner">
        <?php if(!empty($product_detail)){ ?>
            <div class="inner-txt">
               <div class="singleproduct">
                ...
                ?>  
                <div class="zoom-left">
                <img id="zoom_09" src="<?php echo $image; ?>"  data-image="<?php echo $image; ?>" data-zoom-image="<?php echo $full_image;?>" width="450">
                <div id="gallery_09">
                  <?php # if($image1){?>
                  <a href="#" class="elevatezoom-gallery active" data-update="" data-image="<?php echo $image;?>" data-zoom-image="<?php echo $full_image;?>"><img src="<?php echo $image; ?>" height="80" alt="" /></a>
                  <?php # } ?>
                  <?php if($imgtwo){ ?>
                  <a href="#" class="elevatezoom-gallery" data-image="<?php echo $image2;?>" data-zoom-image="<?php echo $full_image2;?>"><img src="<?php echo $image2 ;?>" height="80" alt="" /></a>
                  <?php } ?>
                  <?php if($imgthree){ ?>
                  <a href="#" class="elevatezoom-gallery" data-image="<?php echo $image3;?>" data-zoom-image="<?php echo $full_image3;?>"><img src="<?php echo $image3 ;?>" height="80" alt="" />
                  </a>
                   <?php } ?>
                </div>
                </div>
                ...
                <?php $sizeArr = explode(',',$product_detail['product_size']) ;
                      #pr($sizeArr) ; ?>
                <form action="<?php echo site_url() . $conSeg ;?>/cart/add" method="POST" id="formID">  
                 <?php if($sizeArr[0] !="" ){ ?>
                 <div class="size">
                   <div class="selectimg">
                   <select name="size">
                 ...
                 foreach ($productatrrsetdetail as $key => $optiondetail) {
                    ...
                    if($optiondetail['field_type'] == 'radio' && (count($optiondetail['option_detail']) > 0 )){
                      ...
                      foreach ($optiondetail['option_detail'] as $key => $value) {
                        ...
                        <div class="dyn_fld_50"><input type="radio" name="options[<?php echo $optiondetail['id'] ; ?>][]" value="<?php echo $value['id'] ; ?>" class="<?php echo $required ; ?>" /> <?php echo $value['option_value'] ; ?> <?php if($value['option_price'] > 0){ echo '+ $ '.$value['option_price'] ;}  ?>
                        </div>
