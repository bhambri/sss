<!--banner-->
 <?php #echo $selCategory.$selsubCategory ; ?>
               ...
               <div class="<?php echo $viewclass ;?>">
                ...
                <div class="product <?php echo $class;?>">
                  ...
                  <span class="price"> $<?php  echo $product->product_price ?></span>
                     ...
                     <a href="javascript:void(0)" ; onclick="addtocart('<?php echo base_url(); ?>' ,'<?php echo $product->id; ?>');">
                     ...
                     <img src="<?php echo store_fallback_path('store/images/view.png')?>" alt=""/><br/>View</a></span></div>
                   </div>
                  </div>
                  <?php  }} else{  ?>
