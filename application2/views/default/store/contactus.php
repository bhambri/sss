...
our members and email address to ask your questions.</p>
      ...
      <div class="right">
            <div class="address">
              <h2>Address:</h2>
              <p><strong>Headquarter Address:</strong> <?php echo $company; ?><br/><?php echo $address; ?><br/><?php echo $city; ?>, <?php echo $state_code; ?> <?php echo $zip; ?><br/><br/><strong>Phone:</strong> <?php echo $phone1; ?><br/><strong>Fax:</strong> <?php echo $fax; ?><br/><br/>For question regarding product sales,<br/>
              <?php if($sale_support_email){?>
              <a href="mailto:<?php echo $sale_support_email; ?>" style="color: #ff5d32;"><?php echo $sale_support_email; ?></a><br/>
              <?php } ?>
              <br/>For question regarding partnership opportunities with us<br/>
              <?php if($partner_support_email){ ?>
              <a href="mailto:<?php echo $partner_support_email; ?>" style="color: #ff5d32;"><?php echo $partner_support_email; ?></a><br/>
              <?php } ?>
              <br/>For question regarding technical support issues,<br/>
              <?php if($technical_support_email){ ?>
              <a href="mailto:<?php echo $technical_support_email; ?>" style="color: #ff5d32;"><?php echo $technical_support_email; ?></a>
              <?php } ?>
              </p>                
              <p>
