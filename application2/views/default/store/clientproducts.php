      ...
      ?>
       ...
       <div class="<?php echo $viewclass ;?>">
        ...
        <div class="product <?php echo $class;?>">
           ...
           <a href="<?php echo base_url() .$conSeg; ?>/store/productDetail/<?php echo $product->id; ?>"><img src="<?php echo $image; ?>" alt="" /> </a>
          ...
          <span class="price"> <!-- <img src="images/offer.png" alt=""/><s>$ddd.</s>  -->
             ...
             <a href="javascript:void(0)" ; onclick="addtocart('<?php echo base_url() .$conSeg; ?>' ,'<?php echo $product->id; ?>');">
             <img src="<?php echo store_fallback_path('store/images/buy.png')?>" alt=""/><br/>Buy</a></span> 
             <span class="share"></span>
             <!-- <span class="share"><img src="<?php echo store_fallback_path('store/')?>images/share.png" alt=""/><br/>
             <a href="#">Share</a></span> --> <span class="quick"><a href="<?php echo base_url() .$conSeg; ?>/store/productDetail/<?php echo $product->id; ?>">
             <img src="<?php echo store_fallback_path('store/images/view.png')?>" alt=""/><br/>View</a></span>
             </div>
           </div>
          </div>
          <?php 
