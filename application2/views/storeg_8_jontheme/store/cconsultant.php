...
<div class="inner-banner">
    ...
    <div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segment(1).'/home'?>">Home </a> / Register <?php echo $this->consultant_label ;?> User</div> 
</div> 
<!--banner-->
 <div class="con">
    <div class="con-inner">
    ...
    <?php endif; ?>       
      ...
      <div class="fld">
        <input type="checkbox" name="tnd" <?php echo ($tnd)?'checked':'';?> value="yes" /> <a href="<?php echo base_url().$this->uri->segment(1).'/t_n_c' ?>" target="_blank" >Terms of use</a><span class="star">*</span> 
      </div> 
