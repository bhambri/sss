<script  type="text/javascript" src="<?php echo store_fallback_path('includes/bxslider/jquery.bxslider.min.js')?>"></script>
<!-- bxSlider CSS file -->
<link type="text/css" href="<?php echo store_fallback_path('includes/bxslider/jquery.bxslider.css')?>" rel="stylesheet" />
