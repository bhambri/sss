...
<div class="inner-banner">
  <div class="inner-banner-main">
 	...
 	<div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segments[1].'/store' ;?>">Home </a> / Checkout</div>
</div>
<!--banner-->
<div class="con">
  <div class="con-inner">
    ...
    <div class="inner-txt">  
      ...
      <div class="cart-form">
        ...
        <h5>Shipping Details (Same as billing detail )<input type="checkbox" name="same_as_billing" id="same_as_billing" onclick="sameasbilling(this);"> </input></h5>          
              ...
              <div class="fld-right">
                 Town/City<span class="star">*</span> 
                  <input type="text" name="shipping_city" id="shipping_city" class="inp" value="<?php echo set_value('shipping_city', isset($shipping_data['city']) ? $shipping_data['city'] : ''); ?>">
              </div> 
              <div class="fld-left">
               Email Address<span class="star">*</span> 
