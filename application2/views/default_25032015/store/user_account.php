...
<div class="inner-banner">
      ...
      <div class="breadcrumb"><a href="<?php echo base_url().'home'?>">Home </a> / My account</div>    	  
</div>
<!--banner-->  
     <div class="con">
        <div class="con-inner">
            <div class="inner-txt">
                  <div class="accountpage">
                  	...
                  	<div class="heading">
                  		My Profile <span  class="edit"><a href="<?php echo base_url().'address/shipping';?>">Edit Shipping Detail</a></span>
                  	&nbsp; <span  class="edit"><a href="<?php echo base_url().'address/billing';?>">Edit Billing Detail</a></span>
                    </div>
                  ...
                  <div class="heading">
                  		My Recent Purchase  <span  class="edit"><a href="<?php echo base_url().'user/myorders';?>">View All orders</a></span>
                  </div>
                  	...
                  	<div class="wishlist-details-account">
                  		...
                  		<div class="wishlist-details-txt">
                                  <a href="<?php echo base_url().'store/productDetail/'.$wishlist->product_id;?>">
                  		    ...
                  		    <a href="<?php echo base_url().'user/deleteWishList/'.$wishlist->id; ?>" style="color:red;cursor:pointer;" onclick="return confirm('Are you sure you want to delete this item?');" >Delete</a>
                  		</div> 
                  	...
                  	<div class="wishlist-details-account">
                  		...
                  		?>
                  		<div class="wishlist-details-txt">
                              <a href="<?php echo base_url().'store/productDetail/'.$favourite->prod_id;?>">
                  		    ...
                  		    <a href="<?php echo base_url().'user/deleteFavourites/'.$favourite->id; ?>" style="color:red;cursor:pointer;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                  		</div>
