            ...
            <div class="right-details">
                ...
                <?php #pr() ; ?>
    	   	   	   <div class="share-item">
        	   	   	 ...
        	   	   	 <div class="remove">   		            	   	   	 
        	   	      <a id="removeItem" href="<?php echo site_url().$conSeg.'/cart/removeitem/'.$currentCart['rowid'] ; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img src="<?php echo layout_url('default/store/')?>images/remove.png" alt="" title="Remove from bag" class="vtip"/></a>
                   </div>
                </div>
            </div>
          </div>
