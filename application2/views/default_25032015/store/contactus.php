...
our members and email address to ask your questions.</p>
      ...
      <div class="right">
            <div class="address">
              <h2>Address:</h2>
              <p><strong>Headquarter Address:</strong> <?php echo $company; ?><br/><?php echo $address; ?><br/><?php echo $city; ?>, <?php echo $state_code; ?> <?php echo $zip; ?><br/><br/><strong>Phone:</strong> <?php echo $phone; ?><br/><strong>Fax:</strong> <?php echo $fax; ?><br/><br/>For question regarding product sales,<br/>
