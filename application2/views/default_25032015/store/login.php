 ...
 <div class="con">
    ...
    <?php endif; ?> 
		...
		<div class="fld">
	     ...
	     <div class="fld"> 
	       <div class="txt"><a href="<?php echo base_url() ;?>user/forgot_password">Forgot password?</a> | <a href="<?php echo base_url() ; ?>user/register">Register</a></div>		 <input type="submit" value="Login" class="btn">
	   	 </div>
			<input type="hidden" name="loginFormSubmitted" value="1">       
			<?php echo form_close() ; ?>
		</div>
			<div class="register-btn">	
				<span><a href="<?php echo base_url() ; ?>user/consultant">Register as a <?php echo $this->consultant_label ;?></a></span>
				<span><a href="<?php echo base_url(); ?>user/register">Register as a user</a></span>
			</div>
		</div>
        </div>     
	</div>
