...
<body>
 ...
 <!--header-->
    ...
    <div class="header-strip-main">
        ...
        <form action="<?php echo base_url();?>store/search">
        ...
        <input type="submit" value="Search" class="btn"/>
  	    ...
  	    <?php 
  	    	...
  	    	{
  	    ?>
  	    		<a href="<?php echo base_url().'user/account';?>"><?php echo 'Welcome ' . $storeUserSession['name'];?></a>
  	    ...
  	    ?>
  	     ...
  	     <span class="cart"><a href="<?php echo base_url().'cart/';?>">Cart(<?php echo $this->cart->total_items() ;?>)</a></span>
 	    ...
 	    <div class="header-inner">
	 	 ...
	 	 <div class="right-top">	   
	 	 	   	  <div class="navigation" id="menu">  
			 	 	   ...
			 	 	   <li><a href="<?php echo $this->store_about_us_link ? $this->store_about_us_link : base_url().'home#' ;  ?>" target="_blank">About Us</a></li>
			 	 	   <li><a href="<?php echo base_url();?>store/products">Store</a>
			                ...
			                ?>
				                <ul class="one categorylisting js-masonry" id="container" data-masonry-options='{ "columnWidth": 500, "itemSelector": ".box" }'>
			 	 	     ...
			 	 	     <!-- <li><a href="<?php echo base_url() .  $this->storename; ?>/store/special_offer">Special offer</a></li> -->
			 	 	    <!-- li><a href="<?php echo base_url() .  $this->storename; ?>/store/recently_viewed">Recently viewed</a></li-->
               ...
               <?php }else{ ?>	 
               <li class="no-sp"><a href="<?php echo base_url() .'user/login';?>">Login</a></li>  
               <?php } ?>	   
			 	 	   </ul>	 	 	   
		 	 	  </div> 
                ...
                <ul class="one categorylisting js-masonry" id="container" data-masonry-options='{ "columnWidth": 500, "itemSelector": ".box" }'>
                   ...
                   <?php 
                      if( isset( $categories['subcategory'] ) && !empty( $categories['subcategory'] ) )
                      {
                         ...
                         {                                    
                   ?>          
                            <li><a href="<?php echo base_url();?>store/cat_id/<?php echo $categories['id'].'/'.$subcategory->id;?>"   > <span <?php if(strtolower($this->uri->uri_string) == strtolower('/store/cat_id/'.$categories['id'].'/'.$subcategory->id )){ echo ' class=menuselected '; $selCategory = $categories['name']; $selsubCategory = $subcategory->name ;} ?> > <?php echo $subcategory->name;?></span></a></li>
                    <?php 
                       }  
                      }
                    ?>                            
