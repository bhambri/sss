    ...
    <div class="SACarouselThumbsCol">
        <ul>
            <li class="active bgcol1" id="satopthumbactive-1" style="" title="" onclick="changeWidget('1')">
                ...
                <div class="figure"><img src="<?php echo layout_url('default/store/')?>slider/small1.png" alt="" /></div>
                <div class="txt"><h3>New Fashion</h3>
                 <p>In the past people were born royal. Nowadays royalty comes from what you do.</p>
                </div>
               
              <span class="carouselPointer" style="background:url(<?php echo layout_url('default/store/')?>slider/arrow1.png); background-repeat:no-repeat; width:14px; height:26px;"><img src="<?php echo layout_url('default/store/')?>slider/arrow1.png"/></span> </li>
            ...
            <li class="active bgcol2" id="satopthumbactive-2" style="display:none" title="" onclick="changeWidget('2')">
                ...
                <div class="figure"><img src="<?php echo layout_url('default/store/')?>slider/small2.png" alt=""  /></div>
               <div class="txt"><h3>Special offer today</h3>
                 <p>Tailor made to fit you prefectly any size to dressyou up.</p>
                </div>   
            <span class="carouselPointer"><img src="<?php echo layout_url('default/store/')?>slider/arrow2.png" /></span> </li>
            ...
            <li class="active bgcol3" id="satopthumbactive-3" style="display:none" title="" onclick="changeWidget('3')">
                ...
                <div class="figure"><img src="<?php echo layout_url('default/store/')?>slider/small3.png" alt=""  /></div>
                  <div class="txt"><h3>New Collection</h3>
                 <p>A lace dress is a great time to have an a nice night out in the town.</p>            
                
                 </div>
              <span class="carouselPointer"><img src="<?php echo layout_url('default/store/')?>slider/arrow3.png" /></span> </li>
...
foreach ($banners as $banner_detail) {
  ...
  <div class="SACarouselImgCol" style="" id="satopimage-<?php echo $i ; ?>">
      <!-- <img src="<?php echo layout_url('default/store/')?>slider/banner1.jpg" alt=""/> -->
    ...
    if(@count($news_data) > 0 ){   
      ...
      <div class="news">
         ...
         <div class="details">
            ...
            <p> <a class="readmor" href="<?php echo site_url().'news_detail/'.$news->id ;?>" > Read More</a></p>
         </div>
     </div>
    <?php  } ?>
    <?php }else{ ?>
