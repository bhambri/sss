...
Warranty and Exchanges and Returns</a></li>
    ...
    <div class="copy">Copyright &copy; <?php echo date('Y') ; ?> JonCar Jewelry - All Rights Reserved. <a href="http://cogniter.com/" target="_blank">Site By Cogniter</a> &nbsp; | &nbsp; <!-- <a href="privacy.php">Privacy Policy</a>  &nbsp;  | --> <a href="<?php echo base_url().'t_n_c' ?>" >Terms of use</a></div>
    <div class="social">
    <?php 
