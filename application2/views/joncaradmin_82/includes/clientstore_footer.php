...
?>
 ...
 <div class="footer">
     <div class="footer-inner">
      ...
      <li><a href="<?php echo base_url().$consultantDetail; ?>/warranty-returns-and-exchanges"> 
...
<!-- <div class="payment-strip"><a href="#"><img src="<?php echo store_fallback_path('store/images/ico-payment.png')?>" alt=""/></a></div> -->
    ...
    <div class="copy">Copyright &copy; <?php echo date('Y') ; ?> JonCar Jewelry - All Rights Reserved. <a href="http://cogniter.com/" target="_blank">Site By Cogniter</a> &nbsp; | &nbsp;  <a href="<?php echo base_url().$consultantDetail.'/t_n_c' ?>" >Terms of use</a></div>
    <div class="social">
    <?php 
