    ...
    <span class="login"> 
     ...
     <div class="right-top">
            <div class="navigation" id="menu">  
             ...
             <li class="no-mnu"><a href="http://joncarjewelry.com/blog/">Blog</a></li><!-- https://joncarjewelry.com/blog -->
...
<div class="cart-fld">
   <div class="cart-fld-inner">
    ...
    <div class="txt">Meridian Leather Wrap Bracelet <br/><span>Quantity: <strong>5</strong></div>
   </div> 
