...
class Store extends VCI_Controller {
	...
	function consultant_news(){
        ...
        $view_data['breadcrumbdata'] = array('Home /'=> base_url().$consultantuser."/store" ,
	...
	{	
		...
		//Fetch all pages from database
		$view_data['breadcrumbdata'] = array('Home /'=> base_url()."/store/products" ) ;
