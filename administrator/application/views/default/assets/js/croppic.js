...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			if(that.options.customUploadButtonId ===''){ cropControlUpload = '<i class="cropControlUpload" title=""Upload></i>'; }
			var cropControlRemoveCroppedImage = '<i class="cropControlRemoveCroppedImage" title="Remove Cropped Image"></i>';
		...
		createCropControls: function(){
			...
			if(that.options.doubleZoomControls){
				cropControlZoomMuchIn = '<i class="cropControlZoomMuchIn" title="Zoom Much In"></i>';
				cropControlZoomMuchOut = '<i class="cropControlZoomMuchOut" title="Zoom Much Out"></i>';
			}
