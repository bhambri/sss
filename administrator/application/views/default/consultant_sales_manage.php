				...
				<table align="left" border="0">
					<tr>
						<td class="icon_box">
							...
							<tr>
								<td align="center">   
                                    <select name="consid" id="consid" onchange="setSessionConsSalesReport(this.value, '<?php echo base_url() . 'consultant_sales/manage/' ?>', '<?php echo base_url();?>' )">
						...
						<td class="icon_box">
							...
							<tr>
								<td align="center">   
                                    <select name="adminid" id="adminid" onchange="setSessionSalesReportDuration(this.value, '<?php echo base_url() . 'consultant_sales/manage/' ?>', '<?php echo base_url();?>' )">
						...
						<td class="icon_box">
							<?php echo form_open("consultant_sales/manage",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing'));?>
								...
								<tr>
									<td align="center"> 
										Total: <b>
													...
													$total = $sales_all_sum[0]->sum_order_amount ;
													echo "$".$total; 
													?>
												</b>		
									</td>
...
?></span></td>
				...
				<tr>
					<td colspan="10" align="center">
						<input  type="button" value="Back" class="button" onclick="javascript: window.history.back();" />
					</td>
				</tr>
            </table>
			<?php echo form_close(); ?>
