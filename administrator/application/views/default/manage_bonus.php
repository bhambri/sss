    ...
    <tr>
      <td id="content_center_td" valign="top">
          <div id="content_div">
			<div id="listpage_button_bar" >
				...
				<table align="left" border="0">
					...
					<tr>
							...
							<tr>
								<td align="center">   
                                    <select name="adminid" id="adminid" onchange="setSessionSalesReportDuration(this.value, '<?php echo base_url() . 'consultant/manage_bonus/' ?>', '<?php echo base_url();?>' )">
						...
						<td class="icon_box">
							<?php echo form_open("consultant/manage_bonus",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing'));?>
			...
			<?php echo form_open("consultant/manage_bonus", array('name' => 'userListing', 'id' => 'userListing'));?>
			<input type="hidden" name='page' value="<?php echo $this->uri->segment(3);?>" />
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					...
					<td align="center" class="form_header"><span>Bonus Amount($)</span></td>
				...
				<tr class="<?php echo $rowClass?>">
					...
					<td align="center"><span><?php echo $user['executive_level'] ;?></span></td>
					<td align="center"><span><?php echo $user['bonus_amt'] ;?>$</span></td>
					<td align="center"><span><?php echo $user['created'] ;?></span></td>

					<td nowrap="nowrap" align="center">					
					<?php $statusLink = base_url() . "consultant/update_status_bonus/" . $user['id'] . "/" . $user['is_paid'] . "/" . $this->uri->segment(3)?>
