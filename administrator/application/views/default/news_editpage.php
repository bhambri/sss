...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('news/edit_newsnew',array('id'=>'formEditNews','enctype'=>'multipart/form-data','name'=>'formEditNews', 'onsubmit'=>'return yav.performCheck(\'formEditNews\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="file" name="thumb_image" id="thumb_image"  maxlength = "100" style="width: 200px;" class="inputbox" /></td>
					</tr>
...
$settings = array('w'=>180,'h'=>100,'crop'=>true);
					...
					<tr>
						<td colspan="2" align="center" height="40" valign="bottom">
							...
							<input  type="hidden" name="page_thumbnailpath" value="<?php echo $page_thumbnailpath; ?>" class="button" />
							<input  type="button" value="Cancel" class="button" onclick="javascript: window.location ='<?php echo base_url(); ?>news/manage_news'" />
						</td>
					</tr>
					<tr>
