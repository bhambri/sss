...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('storelinks/add_storelinks',array('id'=>'formAddstorelinks', 'enctype'=>'multipart/form-data','name'=>'formAddstorelinks', 'onsubmit'=>'return yav.performCheck(\'formAddstorelinks\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="file" name="image" id="image"  style="width: 150px;" class="inputbox" value="<?php echo set_value('page_metatitle',@$image);?>" />Best size: max-height:250, max-width: 250 ,max size: 5000 kb</td>

					</tr>
					
					
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Link: </td>
						<td width="60%"><input type="text" name="link" id="link"  style="width: 250px;" class="inputbox" /> </td>
