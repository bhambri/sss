          ...
          <div id="listpage_button_bar" >
				<table align="left" border="0">
					<tr>
						<td class="icon_box">
							...
							<tr>
								...
								<td>
									...
									<label>Include Paid items </label><input type="checkbox" name="includepaiditems"  <?php if($checked == 1){ ?> checked <?php } ?> onchange="setSessionIncludePayItems(this.checked, '<?php echo base_url() . 'commission_order/commission_order_manage/' ?>', '<?php echo base_url();?>' )"  />
								</td>
							</tr>
							<tr>
								<td align="center">
						...
						<td class="icon_box">
							<?php echo form_open("commission_order/commission_order_manage",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing'));?>
            ...
            <div id="listpage_button_bar" >
				...
				<table align="left" border="0">
					<tr>
						<td class="icon_box" onclick="submitListingForm('commissionOrderListing', '<?php echo base_url() . "commission_order/markstatus"?>','markpaid');">
							<table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td align="center">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					...
					<td align="center" class="form_header"><span><input type="checkbox" name="masterCheckField" id="masterCheckField" onclick="checkAll('commissionOrderListing',this);"/></span></td>
					...
					<td align="center" class="form_header"><span>Commission Amount</span></td>
				...
				<?php
				if(!empty($commission_order_data) && count($commission_order_data)>0):
				

					$rowClass = 'row1';

					foreach($commission_order_data as $commission_order):
