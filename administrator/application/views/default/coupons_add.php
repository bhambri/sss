...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('coupons/add_coupons',array('id'=>'formAddcoupons', 'enctype'=>'multipart/form-data','name'=>'formAddcoupons', 'onsubmit'=>'return yav.performCheck(\'formAddcoupons\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><!--  input readonly="readonly" type="text" name="code" id="code"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php if(isset($code)) { echo set_value('code',@$code); }else{ echo set_value('code',$random_code); } ?>" /-->
						<!--input readonly="readonly" type="text" name="code" id="code"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php echo set_value('code',@$code); ?>" /-->
						<input readonly="readonly" type="text" name="code" id="code"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php if( @$code ) { echo $code;} else { echo $random_code; } ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td width="60%">
						    <!--<input type="text" name="expiration_date" id="expiration_date" style="width: 250px;" class="inputbox" value="<?php echo set_value('expiration_date',@$expiration_date);?>"/>-->
