...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('coupons/edit_coupons/'.$id,array('id'=>'formEditcoupons','enctype'=>'multipart/form-data','name'=>'formEditcoupons', 'onsubmit'=>'return yav.performCheck(\'formEditcoupons\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<?php
					if(($coupon_type_id == 2) ||($coupon_type_id == 3)){
					...
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Coupon Code: <span> * </span></td>
						<td width="60%"><input readonly="readonly" type="text" name="code" id="code"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php echo set_value('code',@$code);?>" /></td>
					</tr>
					
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%"><span id="disc_label" style="color:#0f52b6;font-family: arial;"><?php echo $dlabel ;?></span>: <span> * </span></td>
						<td width="60%"><input type="text" name="discount_percent" id="discount_percent" value="<?php echo $discount_percent; ?>" class="inputbox"></td>
					</tr>
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Day of Start: <span> * </span></td>
						<td width="60%">
						    <!--<input type="text" name="expiration_date" id="expiration_date" style="width: 250px;" class="inputbox" value="<?php echo set_value('expiration_date',@$expiration_date);?>"/>-->                     <?php 
						    ...
						    ?>
						    <input type="text" name="from_date" id="from_date" value="<?php if(isset($start_date)){ echo $sdate[0];  }?>"/>
					...
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Day of Expiration: <span> * </span></td>
						<td width="60%">
						    <!--<input type="text" name="expiration_date" id="expiration_date" style="width: 250px;" class="inputbox" value="<?php echo set_value('expiration_date',@$expiration_date);?>"/>-->                     <?php 
						    ...
						    ?>
						    <input type="text" name="to_date" id="to_date" value="<?php if(isset($expire_date)){ echo $date[0];  }?>"/>
					...
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Active: </td>
