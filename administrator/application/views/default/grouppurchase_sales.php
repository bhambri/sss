				...
				<table align="left" border="0">
					<tr>
						...
						<td class="icon_box">
							...
							echo form_open("sales/grouppurchase/" ,array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing'));?>
						...
						<td class="icon_box">
						   <table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
							<td><?php 
							echo '$'.($sales_report_sum[0]->sum_order_amount +$sales_report_sum[0]->sum_tax+$sales_report_sum[0]->sum_shipping)  ;
							?>
