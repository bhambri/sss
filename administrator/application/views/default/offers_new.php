	...
	<tr>
		<td id="content_center_td" valign="top">
			...
			<?php //echo form_open_multipart('front_blocks/front_blocks_new',array('id'=>'frontBlockNew','name'=>'frontBlockNew', 'onsubmit'=>'return yav.performCheck(\'formNewUser\', rules, \'innerHtml\');'));
					echo form_open_multipart('offers/offers_new',array('id'=>'offersNew','name'=>'offersNew'));?>
			...
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="text" name="priority" id="priority"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php echo set_value('priority','');?>" />&nbsp;It should be positive number, greater then 0 (Zero).</td>
					</tr>
