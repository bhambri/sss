...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('promotionrules/add_prule',array('id'=>'formAddcoupons', 'enctype'=>'multipart/form-data','name'=>'formAddcoupons', 'onsubmit'=>'return yav.performCheck(\'formAddcoupons\', rules, \'classic\');'));?>
			<div id="content_div">
