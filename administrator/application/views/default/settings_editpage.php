...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('settings/edit_settings/'.$id,array('id'=>'formEditsettings','enctype'=>'multipart/form-data','name'=>'formEditsettings', 'onsubmit'=>'return yav.performCheck(\'formEditsettings\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%">
						<input type="file" name="logo_image" id="logo_image" > recommended height:160, width: 80 ,max size: 5000 kb
						    <input type="hidden" name="path" id="path" value="<?php echo $logo_image; ?>"/>
					   </td>
					</tr>
					<tr>
					    <td nowrap="nowrap" class="input_form_caption_td" width="40%"><span></span></td>
					    <td>
					         <?php $settings = array('w'=>100,'h'=>100,'crop'=>true);
						    $image = $_SERVER['DOCUMENT_ROOT'].'/' . $logo_image;
						?>
						<img src="<?php echo image_resize( $image, $settings)?>" border='0' /></span>  
					    </td>
					</tr>
