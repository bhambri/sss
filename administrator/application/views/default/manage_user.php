          ...
          <div id="content_div">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				...
				<tr class="<?php echo $rowClass?>">
					...
					<td align="center"><span><?php echo strlen($user->first_name . " " . $user->last_name) > 40 ? substr(ucwords($user->first_name . " " . $user->last_name), 0, 40) . "..." : ucwords($user->first_name . " " . $user->last_name) ;?></span></td>
