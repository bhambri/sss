			...
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="file" name="image" id="image"  style="width: 150px;" class="inputbox" value="<?php echo set_value('page_metatitle',@$image);?>" />max-height:768, max-width: 1024 ,max size: 5000 kb</td>
