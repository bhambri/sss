    ...
    <tr>
      <td id="content_center_td" valign="top">
          <div id="content_div">
			...
			<?php echo form_open("taxes/manage_taxes", array('name' => 'taxListing', 'id' => 'taxListing'));?>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					...
					<td align="center" class="form_header"><span>Tax State</span></td>
					<td align="center" class="form_header"><span>State Code</span></td>

					<td align="center" class="form_header"><span>Tax</span></td>
				...
				<tr class="<?php echo $rowClass?>">
					...
					<td align="center" ><span><a href="<?php if($shipping_states->id){ ?><?php echo base_url()?>taxes/edit_tax/<?php echo $shipping_states->id;?>/<?php echo base64_encode($shipping_states->state); ?><?php }else{  ?><?php echo base_url()?>taxes/add_tax/<?php echo base64_encode($shipping_states->state);?>/<?php echo base64_encode($shipping_states->state_code); ?> <?php } ?>" ><?php echo wrapstr($shipping_states->state_code);?></a></span></td>
					<td align="center"><span><?php echo $shipping_states->tax ? $shipping_states->tax :'NA' ;?></span></td>
					...
					-->
					<td align="center" ><span><a href="<?php if($shipping_states->id){ ?><?php echo base_url()?>taxes/edit_tax/<?php echo $shipping_states->id;?>/<?php echo base64_encode($shipping_states->state); ?><?php }else{  ?><?php echo base_url()?>taxes/add_tax/<?php echo base64_encode($shipping_states->state);?>/<?php echo base64_encode($shipping_states->state_code); ?> <?php } ?>" ><?php echo $shipping_states->id ? 'Edit': 'Add' ;?></a></span></td>
