...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('banners/edit_bannersnew/'.$id,array('id'=>'formEditbanners','enctype'=>'multipart/form-data','name'=>'formEditbanners', 'onsubmit'=>'return yav.performCheck(\'formEditbanners\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="file" name="image" id="image"  style="width: 200px;" class="inputbox" /><span> recommended height:585, width: 1900 ,max size: 5000 kb
						</span>
						</td>
					</tr>
					<tr>
