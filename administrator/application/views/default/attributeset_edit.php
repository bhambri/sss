...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('attributesets/edit/id/'.$this->cat_id ,array('id'=>'formEditclient','name'=>'formEditclient'));?>
			<div id="content_div" align="center">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%" align="left"><input type="text" name="name" id="name"  maxlength = "50" style="width: 150px;" class="inputbox" value="<?php echo (isset($attributeset->name) ? $attributeset->name : set_value('fName',''));?>" /></td>
					</tr>
					
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Description: <span> &nbsp; </span></td>
						<td width="60%"><textarea name="description" id="description"  style="width: 150px; height:100px;" class="inputbox"><?php echo (isset($attributeset->description) ? $attributeset->description : set_value('description',''));?></textarea></td>
					</tr>
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">Active: <span>&nbsp;</span></td>
						<td width="60%" align="left"><input type="checkbox" name="status" id="status" class="inputbox" value="1" <?php echo ((isset($attributeset->status) ? $attributeset->status : set_value('status','')) == 1) ? 'checked="checked"' : '';?> />
						</td>
					</tr>
