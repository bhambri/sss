      ...
      <td id="content_center_td" valign="top">
          <div id="content_div">
			<div id="listpage_button_bar" >
				<?php echo form_open('user/manage_user',array('name'=>'search', 'id'=>'search'));?>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					<td align="center" class="form_header" width=""><span><input <?php if(empty($users)) { echo "disabled"; }?>  type="checkbox" name="masterCheckField" id="masterCheckField" onclick="checkAll('userListing',this);"/></span></td>
					...
					<td class="form_header"  nowrap="nowrap" align="center"><span><?php echo lang('actions')?></span></td>
				</tr>
				<?php
				...
				<tr class="<?php echo $rowClass?>">
					<td align="center" width="5%"><span><input type="checkbox" name="userids[]" value="<?php echo $user->id?>" onclick="checkMasterState('userListing', 'masterCheckField')"/></span></td>
					<td align="center" ><span><a href="<?php echo base_url()?>user/edit_user/<?php echo $user->id;?>" ><?php echo substr($user->username,0,20)?></a></span></td>
					<td align="center"><span><?php echo substr(ucwords($user->first_name), 0, 20);?></span></td>
					<td align="center"><span><?php echo substr(ucfirst($user->last_name),0 ,20);?></span></td>
					<td align="center"><span><?php echo substr($user->email,0,25)?></span></td>
					<td align="center" nowrap="nowrap"><span><?php echo $user->country;?></span></td>
				...
				?>
				<tr class='row0'>
					<td colspan="7" align='center' ><strong><?php echo lang('users_not_found')?></strong></td>
				</tr>
				<?php endif;?>
				<tr>
