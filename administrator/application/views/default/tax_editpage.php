...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('taxes/edit_tax/'.$id.'/'.$this->uri->segments[4],array('id'=>'formEditshipping','enctype'=>'multipart/form-data','name'=>'formEditshipping', 'onsubmit'=>'return yav.performCheck(\'formEditshipping\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="text" name="tax" id="tax"  style="width: 250px;" class="inputbox" value="<?php echo set_value('tax',@$tax);?>" /> </td>
					</tr>
					<!-- <tr>
