...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('shipping/add_shipping/'.$this->uri->segments[3].'/'.$this->uri->segments[4],array('id'=>'formAddshipping', 'enctype'=>'multipart/form-data','name'=>'formAddshipping', 'onsubmit'=>'return yav.performCheck(\'formAddshipping\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						...
						<td width="60%"><input type="text" name="w1" id="w1"  style="width: 250px;" class="inputbox" value="<?php echo set_value('w1','');?>" /> </td>
					</tr>
					<tr>
