...
var rules		= new Array();
	rules['0']		= 'adminusername:Username|required';
	rules['1']		= 'adminusername:Username|alphaspace';
	rules['2']		= 'adminusername:Username|minlength|2';
	rules['3']		= 'adminusername:Username|maxlength|20';
    rules['4']		= 'adminpassword:Password|required';
	rules['5']		= 'adminpassword:Password|minlength|6';
	rules['6']		= 'adminpassword:Password|maxlength|20';
</script>
...
<?php 
$attr = array('name'=>'adminLogin','id'=>'adminLogin','onsubmit'=>"return yav.performCheck('adminLogin',rules,'innerHtml')");
					...
					<td valign="top" width="239">
						<table cellpadding="0" cellspacing="0" border="0" id="id_table_form_inner">
							...
							<tr>
								...
								<td valign="top"><input name="adminusername" type="text" class="inputbox" id="adminusername" size="25" maxlength="40" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="10" height="19" valign="top"></td>
								<td valign="top"><input name="adminpassword" type="password" class="inputbox" id="adminpassword" size="25" maxlength="40"  /></td>
							</tr>
							<tr>
								<td valign="top" width="10"></td>
								<td valign="top" height="10"></td>
								...
								<!-- Below forgot password row -->
									<table width='80%' cellspacing='0' border='0'>
										<tr>
											...
											<td><?php echo anchor('admin/forgot_password',lang('forgot_password'))?></td>
										</tr>
									</table>
								</td>
							</tr>
