          ...
          <div id="content_div">
			...
			<?php 
				...
				<table align="left" border="0">
					<tr>
						<td class="icon_box" onclick="submitListingForm('clientListing', '<?php echo base_url() . "attributesets/delete"?>','delete');">
						...
						{
						?>
						<td class="icon_box" onclick="submitListingForm('clientListing', '<?php echo base_url() . "attributesets/add"?>','new');">
						<?php
						}
						?>
						...
						<td class="icon_box">
							...
							<tr>
								<td align="center">   
                                    <select name="adminid" id="adminid" onchange="setStoreSession(this.value, '<?php echo base_url() . 'attributesets/manage/' ?>', '<?php echo base_url();?>' )">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					<td align="center" class="form_header" ><span><input type="checkbox" <?php if(empty($attributesets)) { echo "disabled"; }?> name="masterCheckField" id="masterCheckField" onclick="checkAll('clientListing',this);"/></span></td>
					<td align="center" class="form_header"><span> Attribute Set <?php # echo lang('category_name')?> </span></td>
				...
				<?php
				if(!empty($attributesets) && count($attributesets)>0):
				...
				<tr class="<?php echo $rowClass?>">
					...
					<td align="center"><span><a href="<?php echo base_url(). 'attributesets/edit/id/'.$attributeset->id; ?>"><?php echo ucwords($attributeset->name);?></a></span></td>
					<td align="center"><span>
					<!-- a href="<?php echo base_url(). 'subcategory/manage/id/'.$attributeset->id; ?>"><?php echo "Attribute set option";?></a-->
