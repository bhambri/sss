...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('shipping/add_shipping/'.$this->uri->segments[3].'/'.$this->uri->segments[4],array('id'=>'formAddshipping', 'enctype'=>'multipart/form-data','name'=>'formAddshipping', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
