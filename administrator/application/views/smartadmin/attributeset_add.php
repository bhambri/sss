			...
			<?php echo form_open_multipart('',array('id'=>'formNewMember','name'=>'formNewMember', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
						...
						<label class="input">
							<input type="text" name="name" id="name"  maxlength = "50" class="input-xs" value="<?php echo set_value('name','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Description:</label>
						<label class="textarea">
							<textarea name="description" id="description" cols="30" rows="4"><?php echo set_value('description', '') ; ?></textarea>
						</label>
					</section>
					<section>
