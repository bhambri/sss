				...
				<fieldset>
					<section>
						...
						<label class="checkbox">
							...
							<input type="checkbox" name="includepaiditems"  <?php if($checked == 1){ ?> checked <?php } ?> onchange="setSessionIncludePayItems(this.checked, '<?php echo base_url() . 'override_order/override_order_manage/' ?>', '<?php echo base_url();?>' )"  />
...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<!-- widget content -->
		<div class="widget-body no-padding">
			<?php echo form_open("override_order/override_order_manage",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing', 'class'=> "smart-form"));?>
...
<section class="pull-left marginBottom10">
	<button type="button" class="btn btn-labeled btn-success" onclick="submitListingForm('overrideOrderListing', '<?php echo base_url() . "override_order/markstatus"?>','markpaid');" >
					...
					<div class="widget-body no-padding">
						<?php echo form_open("override_order/override_order_manage", array('name' => 'overrideOrderListing', 'id' => 'overrideOrderListing'));?>
							...
							<table id="dt_basic" class="table table-striped table-bordered noMarginBottom" >
								<thead>			                
									<tr>
										<th align="center" class="form_header"><span><input type="checkbox" <?php if(empty($override_order_data)) { echo "disabled"; }?> name="masterCheckField" id="masterCheckField" onclick="checkAll('overrideOrderListing',this);"/></span></th>
										<th align="center" class="form_header"><span><?php echo $this->consultant_label ; ?> Name</span></th>
										<th align="center" class="form_header"><span><?php echo $this->consultant_label ; ?> Generational Level</span></th>
										<th align="center" class="form_header"><span>Commission Percentage</span></th>
										<th class="form_header"  nowrap="nowrap" align="center"><span>Commission Amount</span></th>
								...
								<tbody>
									<?php if(!empty($override_order_data) && count($override_order_data)>0) { ?>
										<?php foreach($override_order_data as $override_order): ?>
											<tr>
												...
												<td align="center">
													<span><?php echo $override_order->username; ?></span>
												</td>
												<td align="center">
													<span><?php echo $override_order->consultant_genration_level;?></span>
												</td>
												<td align="center">
													<span>
