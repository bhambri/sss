<?php 
//echo 'kanav is here';die;
?>
<script type="text/javascript">

var rules		= new Array();
	rules['0']		= 'client_adminusername:Username|required';
	rules['1']		= 'client_adminusername:Username|alphaspace';
	rules['2']		= 'client_adminusername:Username|minlength|2';
	rules['3']		= 'client_adminusername:Username|maxlength|20';
    rules['4']		= 'client_adminpassword:Password|required';
	rules['5']		= 'client_adminpassword:Password|minlength|6';
	rules['6']		= 'client_adminpassword:Password|maxlength|20';
</script>
...
<?php 
$attr = array('name'=>'client_adminLogin','id'=>'client_adminLogin','onsubmit'=>"return yav.performCheck('client_adminLogin',rules,'innerHtml')");
echo form_open('client_admin/index', $attr);
?>
...
<table border="0" cellspacing="0" cellpadding="4" align="center" id="id_table_login_form">
	<tr>
		...
		<td valign="top" width="237">
			<!-- Below table provides login fields to get access to client_admin area -->
					...
					<td valign="top" width="239">
						<table cellpadding="0" cellspacing="0" border="0" id="id_table_form_inner">
							...
							<tr>
								...
								<td valign="top"><input name="client_adminusername" type="text" class="inputbox" id="client_adminusername" size="25" maxlength="40" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td width="10" height="19" valign="top"></td>
								<td valign="top"><input name="client_adminpassword" type="password" class="inputbox" id="client_adminpassword" size="25" maxlength="40"  /></td>
							</tr>
							<tr>
								<td valign="top" width="10"></td>
								<td valign="top" height="10"></td>
								...
								<!-- Below forgot password row -->
									<table width='80%' cellspacing='0' border='0'>
										<tr>
											...
											<td><?php echo anchor('client_admin/forgot_password',lang('forgot_password'))?></td>
										</tr>
									</table>
								</td>
							</tr>
...
<script type="text/javascript">
document.client_adminLogin.client_adminusername.focus();
</script>
<?php echo form_close();?>
