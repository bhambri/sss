...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('executives/executive_new',array('id'=>'executiveNew','name'=>'executiveNew', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
						<label class="label">Executive Level :<span class="mandatory">*</span></label>
						<label class="input">
							<input type="text" name="e_level" id="e_level"  maxlength = "50" class="inputbox" value="<?php echo set_value('e_level','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Bonus Amount :<span class="mandatory">*</span></label>
						<label class="input">
							<input type="number" name="bonus_amt" id="bonus_amt"  maxlength = "100" class="inputbox" value="<?php echo set_value('bonus_amt','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Executive Level order:<span class="mandatory">*</span></label>
						<label class="input">
							<input type="text" name="exec_order" id="exec_order"  maxlength = "100" class="inputbox" value="<?php echo set_value('exec_order','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Generation Access:<span class="mandatory">*</span></label>
						<label class="input">
							<input type="text" name="g_access" id="g_access"  maxlength = "50" class="inputbox" value="<?php echo set_value('g_access','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Direct Commission (%) :<span class="mandatory">*</span></label>
						<label class="input">
							<input type="number" name="d_commission" id="d_commission"  maxlength = "100" class="inputbox" value="<?php echo set_value('d_commission','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Configurable Volume (%) :</label>
						<label class="input">
							<input type="number" name="configurable_volume_percentage" id="configurable_volume_percentage"  maxlength = "100" class="inputbox" value="<?php echo set_value('configurable_volume_percentage','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Personal Purchase Volume (%) :</label>
						<label class="input">
							<input type="number" name="personal_purchase_volume" id="personal_purchase_volume"  maxlength = "100" class="inputbox" value="<?php echo set_value('personal_purchase_volume','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Personal Customer Volume (%) :</label>
						<label class="input">
							<input type="number" name="personal_customer_volume" id="personal_customer_volume"  maxlength = "100" class="inputbox" value="<?php echo set_value('personal_customer_volume','');?>" />
						</label>
					</section>
					<section>
						<label class="label">Configurable Binary Volume (%) :</label>
						<label class="input">
							<input type="number" name="configurable_binary_volume" id="configurable_binary_volume"  maxlength = "100" class="inputbox" value="<?php echo set_value('configurable_binary_volume','');?>" />
						</label>
					</section>
				</fieldset>
				<footer>
...
<script type="text/javascript">
	$(document).ready(function() {
		var $checkoutForm = $('#executiveNew').validate({
			rules : {
