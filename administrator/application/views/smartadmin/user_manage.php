...
<section class="pull-left marginBottom10">
	<button type="button" class="btn btn-labeled btn-danger" onclick="submitListingForm('userListing', '<?php echo base_url() . "user/delete_user"?>','delete');" >
		<span class="btn-label">
			<i class="glyphicon glyphicon-minus"></i>
		</span>
		Delete
	</button>
	<button type="button" class="btn btn-labeled btn-success" onclick="submitListingForm('userListing', '<?php echo base_url() . "user/new_user"?>','new');" >
		<span class="btn-label">
					...
					<div class="widget-body no-padding">
						<?php echo form_open("user/manage_user", array('name' => 'userListing', 'id' => 'userListing'));?>
							...
							<table id="dt_basic" class="table table-striped table-bordered noMarginBottom" >
								<thead>			                
									<tr>
										<th align="center" class="form_header" ><span><input type="checkbox" name="masterCheckField" id="masterCheckField" onclick="checkAll('userListing',this);"/></span></th>
								...
								<tbody>
									...
									<?php else: ?>
										<tr>
											<td colspan="5" align='center' ><strong><?php echo lang('users_not_found')?></strong></td>
										</tr>
									<?php endif;?>
								</tbody>
							</table>
