	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('content/edit_page/'.$id,array('id'=>'formEditPage','name'=>'formEditPage','class'=>"smart-form"));?>
				<fieldset>
					<section>
						<label class="label">Page Title:<span class="mandatory">*</span></label>
						<label class="input">
							<input type="text" name="page_title" id="page_title"  maxlength="100" class="inputbox" value="<?php echo set_value('page_title',$page_title);?>" />
						</label>
					</section>
					<section>
						<label class="label">Page Name:<span class="mandatory">*</span></label>
						<label class="input">
							<input type="text" name="page_name" id="page_name"  maxlength = "50" readonly="readonly" class="inputbox" value="<?php echo set_value('page_name',$page_name);?>" />
						</label>
					</section>
					<section>
						<label class="label">Meta Title:</label>
						<label class="input">
							<input type="text" name="page_metatitle" id="page_metatitle"  maxlength="100" class="inputbox" value="<?php echo set_value('page_metatitle',$page_metatitle);?>" />
						</label>
					</section>
					<section>
					...
					<section>
						<label class="label">Content:<span class="mandatory">*</span></label>
						<label class="textarea">
							<textarea name="page_content" id="page_content" class="mceEditor" cols="61" rows="4"><?php echo set_value('page_content',$page_content)?></textarea>
						</label>
					</section>
				</fieldset>
				<footer>
