...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('subcategory/edit/id/'.$this->cat_id ,array('id'=>'formEditclient','name'=>'formEditclient', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
					...
					<section>
						...
						<label class="input">
							<input type="text" name="name" id="name"  maxlength = "50" class="inputbox" value="<?php echo (isset($subcategory->name) ? $subcategory->name : set_value('fName',''));?>" />
						</label>
					</section>
					<section>
						<label class="label">Description :</label>
						<label class="textarea">
							<textarea name="description" id="description" cols="30" rows="4"><?php echo (isset($subcategory->description) ? $subcategory->description : set_value('description',''));?></textarea>
						</label>
					</section>
					<section>
						<label class="checkbox">
							<input type="checkbox" name="status" id="status" class="inputbox" value="1" <?php echo ((isset($subcategory->status) ? $subcategory->status : set_value('status','')) == 1) ? 'checked="checked"' : '';?> />
							<i></i>
