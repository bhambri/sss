...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<form class="smart-form">
			<?php echo form_open("consultant/manage_volume_commission",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing', 'class' => "smart-form"));?>
							...
							<table id="dt_basic" class="table table-striped table-bordered noMarginBottom" >
								<thead>			                
									<tr>
										...
										<th align="center" class="form_header"><span>PPV(%) Applied</span></th>
										<th align="center" class="form_header"><span>PCV(%) Applied</span></th>
										<th align="center" class="form_header"><span>CBV(%) Applied</span></th>
										<th align="center" class="form_header"><span>Actual PPV($)</span></th>
										<th align="center" class="form_header"><span>Actual PCV($)</span></th>
										<th align="center" class="form_header"><span>Actual CBV($)</span></th>
										<th align="center" class="form_header"><span>Total Commission</span></th>
								...
								<tbody>
									<?php if(!empty($users) && count($users)>0) { ?>
										<?php foreach($users as $user): ?>
											<tr>
												<td align="center"><span><?php echo substr($user['username'],0,20)?></span></td>
