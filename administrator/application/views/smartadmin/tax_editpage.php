...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('taxes/edit_tax/'.$id.'/'.$this->uri->segments[4],array('id'=>'formEditshipping','enctype'=>'multipart/form-data','name'=>'formEditshipping', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
					...
					<section>
						...
						<label class="input">
							<input type="text" name="tax" id="tax"   class="inputbox" value="<?php echo set_value('tax',@$tax);?>" />
						</label>
					</section>
				</fieldset>
				<footer>
