	...
	<div class="alert alert-info">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
				<h3 class="no-margin">Total of order amount only</h3>
				<ul>
					<li>Total : 
						<strong width="23%">
							<?php 
...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<!-- widget content -->
		<div class="widget-body no-padding">
			<?php echo form_open("consultant_sales/manage",array( 'method'=>'GET' , 'name' => 'memberListing', 'id' => 'memberListing', 'class'=> "smart-form"));?>
