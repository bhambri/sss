...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('storelinks/add_storelinks',array('id'=>'formAddstorelinks', 'enctype'=>'multipart/form-data','name'=>'formAddstorelinks', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
...
<script type="text/javascript">
	$(document).ready(function() {
		var $checkoutForm = $('#formAddstorelinks').validate({
			rules : {
				title : {
					required : true
				},
