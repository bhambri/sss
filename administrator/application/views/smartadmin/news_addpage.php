...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('news/add_news',array('id'=>'formAddNews', 'enctype'=>'multipart/form-data','name'=>'formAddNews', 'class'=>"smart-form")); ?>
				<fieldset>
					<section>
					...
					<section>
						...
						<label class="textarea">
							<textarea name="page_content" id="page_content" class="mceEditor" cols="61" rows="4" value="<?php echo set_value('page_content', @$page_content ) ;?>"><?php echo set_value('page_content', @$page_content ) ;?></textarea>
						</label>
					</section>
				</fieldset>
				<footer>
...
<script type="text/javascript">
	$(document).ready(function() {
		var $checkoutForm = $('#formAddNews').validate({
			rules : {
				page_title : {
					required : true
				},
