...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open_multipart('',array('id'=>'formNewMember','enctype'=>'multipart/form-data','name'=>'formNewMember', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
					...
					<section>
						...
						<label class="input">
							<input readonly="readonly" type="text" name="group_event_code" id="group_event_code"  maxlength="50" class="inputbox" value="<?php echo $random_code;?>" />
						</label>
					</section>
					<section>
