...
//<![CDATA[
	...
	rules[1] = 'page_content:<b>Content</b>|custom|content_validate()';
...
<table border="0" cellspacing="0" cellpadding="0" class="page_width">
	...
	<tr>
		<td id="content_center_td" valign="top">
			<?php echo form_open('area/edit_area',array('id'=>'formEditPage','name'=>'formEditPage', 'onsubmit'=>'return yav.performCheck(\'formEditPage\', rules, \'classic\');'));?>
			<div id="content_div">
				<table width="80%" border="0" cellspacing="0" cellpadding="2" align="center" class="input_table">
					...
					<tr>
						<td nowrap="nowrap" class="input_form_caption_td" width="40%">City Name: <span> * </span></td>
						<td width="60%"><input type="text" name="name" id="page_title"  maxlength = "100" style="width: 150px;" class="inputbox" value="<?php echo set_value('name',$name);?>" /></td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center" height="40" valign="bottom">
							...
							<input type="hidden" name="status" value="<?php echo $status;?>" class="button" />
						</td>
					</tr>
					<tr>
