      ...
      <td id="content_center_td" valign="top">
          <div id="content_div">
			<div id="listpage_button_bar" >
				<?php echo form_open('area/manage_area',array('name'=>'search', 'id'=>'search', 'method'=>'GET'));?>
						...
						<td style="padding: 0px 7px 0px 7px;">
							<fieldset class="fieldset">
								...
								<div style="margin: 5px;">
								 ...
								 <br /><small>&#8226; Search using name only</small>
								</div>
							</fieldset>
						</td>
					</tr>
				...
				<table align="left" border="0">
					<tr>
						<td class="icon_box" onclick="submitListingForm('areaListing', '<?php echo base_url() . "area/delete_area"?>','delete');">
						  ...
						  <td class="icon_box" onclick="submitListingForm('areaListing', '<?php echo base_url() . "area/add_area"?>','new');">
							<table border="0" cellspacing="0" cellpadding="0" align="center">
							<tr>
								<td align="center">
			...
			<?php echo form_open("area/manage_area", array('name' => 'areaListing', 'id' => 'areaListing'));?>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="2" align="center" class="listing_table">
				<tr>
					<td align="center" class="form_header" ><span><input type="checkbox" name="masterCheckField" id="masterCheckField" onclick="checkAll('areaListing',this);"/></span></td>
					<td align="center" class="form_header"><span>Name</span></td>
					<!-- <td align="center" class="form_header"><span>ShortDesc.</span></td> -->
				...
				<tr class="<?php echo $rowClass?>">
					<td align="center" width="5%"><span><input type="checkbox" name="pageids[]" value="<?php echo $page->id?>" onclick="checkMasterState('areaListing', 'masterCheckField')"/></span></td>
					<td align="center" ><span><a href="<?php echo base_url()?>area/edit_area/<?php echo $page->id;?>" ><?php echo wrapstr($page->name);?></a></span></td>
					<!-- <td align="center"><span><?php echo wrapstr($page->page_shortdesc);?></span></td> -->
					<td align="center"><span></span>
						<?php $statusLink = base_url() . "area/update_status/" . $page->id . "/" . $page->status . "/" . $this->uri->segment(3)?>
				...
				?>
				<tr class='row0'>
					<td colspan="7" align='center' ><strong>No area records Found.</strong></td>
				</tr>
				<?php endif;?>
				<?php if($content){?>
					<tr>
