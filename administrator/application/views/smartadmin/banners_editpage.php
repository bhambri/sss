...
<div class="jarviswidget jarviswidget-sortable" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
	...
	<div role="content">
		...
		<div class="widget-body no-padding">
			<?php echo form_open('banners/edit_bannersnew',array('id'=>'formEditbanners', 'enctype'=>'multipart/form-data','name'=>'formEditbanners', 'class'=>"smart-form"));?>
				<fieldset>
					<section>
...
<script type="text/javascript">
	$(document).ready(function() {
		var $checkoutForm = $('#formEditbanners').validate({
			rules : {
				title : {
					required : true
				},
