...
function submitListingForm(formid, actionURL, mode, masterId) {
    ...
    if (mode == 'delete') {
        if (ischecked == true) {
			$.SmartMessageBox({
				"title": "<i class='fa fa-trash-o txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Delete Action</strong></span>",
				"content": "Are you sure, you want to proceed for deletion?",
				"buttons": "[No][Yes]"
			}, function(a) {
				if(a== 'Yes') {
			...
			$.SmartMessageBox({
				"title": "<i class='fa fa-trash-o txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Delete Action</strong></span>",
				"content": "Please Select atleast one checkbox to delete",
				"buttons": "[Ok]"
			});
            return false;
        }
    ...
    if (mode == 'markpaid') {
        if (ischecked == true) {
			$.SmartMessageBox({
				"title": "<i class='fa fa-trash-o txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Mark Paid</strong></span>",
				"content": "Are you sure, you want to proceed for marking paid ?",
				"buttons": "[No][Yes]"
			}, function(a) {
				if(a== 'Yes') {
					formObj.action = actionURL;
			...
			$.SmartMessageBox({
				"title": "<i class='fa fa-trash-o txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Delete Action</strong></span>",
				"content": "Please Select atleast one checkbox to mark paid",
				"buttons": "[Ok]"
			});
            return false;
        }
    ...
    if (mode == 'markread') {
        if (ischecked == true) {
			$.SmartMessageBox({
				"title": "<i class='fa fa-credit-card txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Mark Read</strong></span>",
				"content": "Are you sure, you want to proceed for marking read ?",
				"buttons": "[No][Yes]"
			}, function(a) {
				if(a== 'Yes') {
					formObj.action = actionURL;
			...
			$.SmartMessageBox({
				"title": "<i class='fa fa-trash-o txt-color-orangeDark'></i> <span class='txt-color-orangeDark'><strong>Mark Read Action</strong></span>",
				"content": "Please Select atleast one checkbox to mark read",
				"buttons": "[Ok]"
			});
            return false;
        }
