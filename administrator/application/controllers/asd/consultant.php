...
class Consultant extends VCI_Controller {
	...
	*/
	...
	function update_status_allcommisions($id = null, $status = 1, $page = 0) {
		$this->_vci_layout('menu-toolbar');
		$this->load->model('user_model');
		...
		//update the status for the user and redirect to listing with success msg
		$result = $this->user_model->update_status_allcommisions($id);
...
function update_status_bonus($id = null, $status = 1, $page = 0)
	...
	*/
	...
	//	$view_data['current_edit_user_id'] = $this->uri->segment(3);
		...
		$crumbs = breadcrumb(array(
				lang('desktop') => array('link'=>'/', 'attributes' => array('class'=>'breadcrumb')),
				'Manage Generational Commission Setting'=> array('link'=>base_url().'consultant/commission_setting', 'attributes' => array('class'=>'breadcrumb')),
	...
	function invite_add()
	{
		...
		$crumbs = breadcrumb(array(
				lang('desktop') => array('link'=>'/', 'attributes' => array('class'=>'breadcrumb')),
				'Manage Invite'=> array('link'=>base_url().'consultant/invite_manage', 'attributes' => array('class'=>'breadcrumb')),
