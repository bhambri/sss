<?php
    ...
    class CI_Paypalrefund
    {
        ...
        function __construct($mode = "live")
        {
            ...
            {
                #$this->API_Username = "pchauhan_api1.cogniter.com";
                #$this->API_Password = "5HLCMMHHNW4CMREE";                
                #$this->Signature = "A3F3DBBGDRR5aQT9eUS.0c7xSm6BAFv.knI6ECjJojoV2KyuIC02qPx.";
	    ...
	    $this->API_Username = $aryData['paypal_username'];
	    $this->API_Password = $aryData['paypal_password'];                
	    $this->Signature = $aryData['paypal_signature'];
            ...
            if(trim(@$aryData['transactionID'])=="")
                return array("ERROR_MESSAGE"=>"Transaction ID is Missingddd");
