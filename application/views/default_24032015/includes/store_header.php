 ...
 <!--header-->
    ...
    <div class="header-strip-main">
        ...
        <input type="submit" value="Search" class="btn"/>
  	    ...
  	    <?php 
  	    	...
  	    	{
  	    ?>
  	    		<a href="<?php echo base_url() .  $this->storename . '/user/account';?>"><?php echo 'Welcome ' . $storeUserSession['name'];?></a>
   ...
   <div class="header">
 	    <div class="header-inner">
 	 	 <div class="logo"><a href="<?php echo base_url() .  $this->storename; ?>/home">
	 	 ...
	 	 <div class="right-top">	   
	 	 	   	  <div class="navigation" id="menu">  
			 	 	   ...
			 	 	   <li><a href="<?php echo base_url() .  $this->storename; ?>/store/product">Store</a>
