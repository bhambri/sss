...
<link href="<?php echo layout_url('default/store/')?>css/style.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="<?php echo layout_url('default/store/')?>fonts/stylesheet.css" type="text/css"/>
<link type="text/css" href="<?php echo layout_url('default/store/')?>menu/menu.css" rel="stylesheet" />
<script type="text/javascript" src="<?php echo layout_url('default/store/')?>menu/menu.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo layout_url('default/store/')?>resp-new/css.css"/>
<noscript>
...
<script src="<?php echo layout_url('default/store/')?>resp-new/jquery.js"></script>
<script src="<?php echo layout_url('default/store/')?>resp-new/doubletaptogo.js"></script>
...
<!--tabs-->
<script type="text/javascript" src="<?php echo layout_url('default/store/')?>tabs/tabber.js"></script>
<link rel="stylesheet" href="<?php echo layout_url('default/store/')?>tabs/example.css" TYPE="text/css" MEDIA="screen"/>
...
?>   
     ...
     <!--poppup--> 
   <link rel="stylesheet" href="<?php echo layout_url('default/store/')?>popup/css/colorbox.css" />
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
		<script src="<?php echo layout_url('default/store/')?>popup/js/jquery.colorbox.js"></script>
		<script>
...
<script src="<?php echo layout_url('default/store/')?>zoom/ga.js" async="" type="text/javascript"></script>
<script src="<?php echo layout_url('default/store/')?>zoom/jquery.js" type="text/javascript"></script>
...
function addtocart(baseurl, productid){
 ...
 <!--tooltip-->
 <script type="text/javascript" src="<?php echo layout_url('default/store/')?>tooltip/vtip.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo layout_url('default/store/')?>tooltip/css/vtip.css" />
 <!--tooltip-->
   
    
<!--slider-->
<link href="<?php echo layout_url('default/store/')?>slider/css/slider.css" type="text/css" rel="stylesheet"/>
<script language="javascript" src="<?php echo layout_url('default/store/')?>slider/js/header123.js"></script>
<!--slider-->
 ...
 <!--header-->
    ...
    <div class="header-strip-main">
        ...
        <input type="submit" value="Search" class="btn"/>
  	    ...
  	    <?php 
  	    	...
  	    	{
  	    ?>
  	    		<a href="<?php echo base_url() .  $this->storename .'/'.$segsments[2].'/user/account';?>"><?php echo 'Welcome ' . $storeUserSession['name'];?></a>
   ...
   <div class="header">
 	    <div class="header-inner">  
 	 	 ...
 	 	 <!--  img src="<?php echo layout_url('default/store/')?>images/logo.png" alt=""/-->
	 	 ...
	 	 <div class="right-top">	   
             ...
             <li><a href="<?php echo $this->store_about_us_link ? $this->store_about_us_link : base_url().$this->storename.'/'.$consultantDetail.'/home#' ;  ?>" target="_blank">About Us</a></li>
			 	 	   ...
			 	 	   <li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail ; ?>/store/product">Store</a>
               ...
               ?> 
               <?php }else{ ?>   
               <li class="no-sp"><a href="<?php echo base_url() .  $this->storename .'/'.$segsments[2].'/user/login';?>">Login</a></li>  
               <?php } ?> 
	...
	<span class="mobile-txt">Menu</span>
		...
		<ul class="clearfix">
							...
							<li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail ; ?>/store/product">Store</a>
							<!-- <ul>
<li><a href="#">Activewear Store</a></li>
<li><a href="#">Shoe Store</a></li>
<li><a href="#">Clothes Store</a></li>
<li><a href="#">Jewellery Store</a></li>
</ul> -->
							<?php 
