...
<div class="inner-banner">
 ...
 <h2>cart</h2>
  ...
  <div class="breadcrumb"><a href="<?php echo base_url() .$this->uri->segments[1].'/store'?>">Home </a>/ Cart</div>
</div>
<!--banner-->
      ...
      ?>
	   ...
	   <div class="right-details">
        ...
        <?php } ?>
           ...
           <div class="remove">                              
            <a id="removeItem" href="<?php echo site_url() . $this->storename.'/cart/removeitem/'.$currentCart['rowid'] ; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img src="<?php echo layout_url('default/store/')?>images/remove.png" alt="" title="Remove from bag" class="vtip"/></a>
           </div>     		            	   	   	 
  	   	</div>
	   </div>
  	</div>
            ...
            <?php 
              /*
                if( isset( $shipping_cost ) && !empty( $shipping_cost ) )
                {
                    ...
                    $grand_total = $shipping_cost + $grand_total;
                }
                else
                {
                    $grand_total = $this->cart->total();
