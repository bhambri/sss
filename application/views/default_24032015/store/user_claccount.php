      ...
      <div class="con-inner">
            <div class="inner-txt">
                  <div class="accountpage">
                        ...
                        &nbsp;<span  class="edit"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/address/billing';?>">Edit Billing Detal</a></span>
                        </div>
                        ...
                        <a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/user/deleteWishList/'.$wishlist->id; ?>" style="color:red;cursor:pointer;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                        </div> 
                        ...
                        <a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/user/deleteFavourites/'.$favourite->id; ?>" style="color:red;cursor:pointer;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                        </div>
