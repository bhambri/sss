...
<div class="inner-banner">
    <div class="inner-banner-main">
     <h2>Register as a <?php echo $this->consultant_label ;?></h2>
     </div>         
    <div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/home'?>">Home </a> / Register <?php echo $this->consultant_label ;?> User</div> 
</div> 
<!--banner-->
 <div class="con">
    <div class="con-inner">
    ...
    <?php endif; ?>       
      ...
      <div class="fld">
        ...
        <input type="text" maxlength="40" name="name" id="name"  value="<?php echo set_value('name', $name ) ; ?>" class="inp">
      </div>
      ...
      <div class="fld">
        <input type="checkbox" name="tnd" <?php echo ($tnd)?'checked':'';?> value="yes" /> <a href="<?php echo base_url().$this->storename.'/'.$this->uri->segment(2).'/t_n_c' ?>" target="_blank" >Terms of use</a><span class="star">*</span> 
      </div> 
