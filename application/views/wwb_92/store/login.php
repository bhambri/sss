    ...
    <?php echo form_open('',array('id'=>'formAddPage','name'=>'formAddPage'));?>   
		...
		<div class="fld">
	     ...
	     <input type="submit" value="Login" class="btn">
	       ...
	       <div class="txt"><a href="<?php echo base_url() .  $this->storename; ?>/user/forgot_password">Forgot password?</a> 
	     </div>		 
	   	 </div>
			...
			<div class="register-btn">	
				<span class="stylist"><a href="<?php echo base_url() .  $this->storename; ?>/user/consultant">Register as a <?php echo $this->consultant_label ;?></a></span>
