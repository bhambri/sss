...
<div id="home-footer">
		<div id="home_contnet">
			...
			<a href="<?php echo base_url() .  $this->storename.'/'.$segs[2]; ?>/numismatic-coins">
			...
			<div class="cost_home home-box">
				<a href="<?php echo base_url() .  $this->storename.'/'.$segs[2]; ?>/atcost-bullion">
			...
			<div class="power_home home-box">
				<a href="<?php echo base_url() .  $this->storename.'/'.$segs[2]; ?>/products-power">
