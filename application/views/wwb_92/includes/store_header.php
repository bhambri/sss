...
if((count($arrd) > 2) && (!in_array('home' ,$arrd)))
{ 
?>
...
<!-- start header-->
	<div id="header">
		...
		<div id="main_nav">
			<ul>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/home" <?php if(in_array($segs[2],array('home'))){?>class="active"<?php } ?>>Home</a></li>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/company-profile" <?php if(in_array($segs[2],array('company-profile','culture','executive_team','policies_procedures'))){?>class="active"<?php } ?>>Company</a></li>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/products-power" <?php if(in_array($segs[2],array('products-power','products-passion','atcost-bullion','numismatic-coins'))){?>class="active"<?php } ?>>Products</a></li>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/services" <?php if(in_array($segs[2],array('services','theft_service','tax_service'))){?>class="active"<?php } ?>>Services</a></li>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/opportunity" <?php if(in_array($segs[2],array('opportunity','recognition','compensation-plan'))){?>class="active"<?php } ?>>Opportunity</a></li>
				<li><a href="<?php echo base_url() .  $this->storename; ?>/contact-us" <?php if(in_array($segs[2],array('contact-us'))){?>class="active"<?php } ?>>Contact Us</a></li>
...
<li><a href="<?php echo base_url() .  $this->storename; ?>/store/products">Shop Now</a></li>
