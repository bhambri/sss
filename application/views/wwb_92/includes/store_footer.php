...
<div class="footer">
  <div class="footer_left">
    <ul>
          ...
          <li><a href="<?php echo base_url() .  $this->storename; ?>/company-profile">Company</a></li>
          <li><a href="<?php echo base_url() .  $this->storename; ?>/products-power">Products</a></li>
          <li><a href="<?php echo base_url() .  $this->storename; ?>/opportunity">Opportunity</a></li>
          <li><a href="<?php echo base_url() .  $this->storename; ?>/contact-us">Contact Us</a></li>
