  ...
  var tax = 0 ;
        ...
        {   
          jQuery('input[name=coupon_code]').val(coupon);
            var baseurl = '<?php echo site_url();?>'+'<?php echo $segsments[1] ; ?>'+'/'+'<?php echo $segsments[2] ; ?>'+'/';
...
<div class="container">
	...
	<a href="https://worldwidebullionaires.com/MemberToolsDotNet/ShoppingCartv3/ViewShoppingCart.aspx">Login</a>
...
<!-- start header-->
	<div id="header">
		<div id="logo">
			...
			<a href="<?php echo base_url() ;?><?php echo $this->storename.'/'.$segsments[2]; ?>/home">
		...
		<div id="main_nav">
			<ul>
				<li><a href="<?php echo base_url() . $this->storename.'/'.$segsments[2]; ?>/home" <?php if(in_array($segs[3],array('home'))){?>class="active"<?php } ?>>Home</a></li>
				<li><a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2];?>/company-profile" <?php if(in_array($segs[3],array('company-profile','culture','executive_team','policies_procedures'))){?>class="active"<?php } ?>>Company</a></li>
				<li><a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2]; ?>/products-power" <?php if(in_array($segs[3],array('products-power','products-passion','atcost-bullion','numismatic-coins'))){?>class="active"<?php } ?>>Products</a></li>
				<li><a href="<?php echo base_url() . $this->storename.'/'.$segsments[2]; ?>/services" <?php if(in_array($segs[3],array('services','theft_service','tax_service'))){?>class="active"<?php } ?>>Services</a></li>
				<li><a href="<?php echo base_url() . $this->storename.'/'.$segsments[2]; ?>/opportunity" <?php if(in_array($segs[3],array('opportunity','recognition','compensation-plan'))){?>class="active"<?php } ?>>Opportunity</a></li>
				<li><a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2]; ?>/contact-us" <?php if(in_array($segs[3],array('contact-us'))){?>class="active"<?php } ?>>Contact Us</a></li>
...
<li><a href="<?php echo base_url().$this->storename.'/'.$segsments[2] ; ?>/store/products">Shop Now</a></li>
      ...
      <div class="my_account_nav">
			<span class="cart"><a href="<?php echo base_url() . $this->storename.'/'.$segsments[2].'/cart/';?>">Cart(<?php echo $this->cart->total_items() ;?>)</a></span>
        ...
        <span class="account">
  	    ...
  	    ?>
  	    		...
  	    		<a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2]. '/user/logout';?>">Logout</a>
  	    <?php 
  	    	}
  	    	else
  	    	{
  ...
  <span class="account-dropdown">       
    <a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2].'/user/myorders';?>"> My orders</a><br/>
   <a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2].'/user/account';?>"> Account Info</a><br/>
    <a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2].'/user/changepassword';?>">Change Password</a><br/>
   <a href="<?php echo base_url() .  $this->storename.'/'.$segsments[2].'/user/mywishlist';?>"> My wishlist</a><br/>
  </span>
  	    </span>
  	    	 <?php 
                if( isset( $storeUserSession ) && !empty( $storeUserSession ) && is_array( $storeUserSession ) )
               ...
               <?php }else{ ?>	
		<span class="login"> 
               <a href="<?php echo base_url() . $this->storename.'/'.$segsments[2]. '/user/login';?>">Login</a>
 		</span>
               <?php } ?>
               </div> 
...
<div class="header">
     ...
     <div class="logo"><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail ; ?>/home">
     <img src="<?php echo base_url();?><?php echo $this->logo_image; ?>" alt=""/>
     </a></div>
     <div class="header-strip">
<div class="header-strip-main">
  <form action="<?php echo base_url().$segsments[1].'/'.$segsments[2] ;?>/store/search">
  ...
  <span class="cart"><a href="<?php echo base_url() .  $this->storename .'/'.$segsments[2].'/cart/';?>">Cart(<?php echo $this->cart->total_items() ;?>)</a></span>
        ...
        ?>
      <span class="account-dropdown">       
        <a href="<?php echo base_url() .  $this->storename .'/'.$consultantDetail.'/user/myorders';?>"> My orders</a><br/>
        <a href="<?php echo base_url() .  $this->storename .'/'.$consultantDetail.'/user/account';?>"> Account Info</a><br/>
        <a href="<?php echo base_url() .  $this->storename .'/'.$consultantDetail.'/user/changepassword';?>">Change Password</a><br/>
        <a href="<?php echo base_url() .  $this->storename .'/'.$consultantDetail. '/user/mywishlist';?>"> My wishlist</a><br/>
      </span>
      </span> 
      <?php 
        if( isset( $storeUserSession ) && !empty( $storeUserSession ) && is_array( $storeUserSession ) )
     ...
     <div class="right-top">     
            <div class="navigation" id="menu">  
             <ul>
             <li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail ; ?>/home">Home</a></li>
             <li><a href="<?php echo base_url().$this->storename.'/'.$consultantDetail ;?>/about-us">About Us</a></li>
             <li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail ; ?>/store/product">Shop</a>
               ...
               <?php 
                ...
                {
               ?> 
    <li class="no-mnu"><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail; ?>/contact">Contact Us</a></li>
               <?php }else{ ?>   
    <li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail; ?>/contact">Contact Us</a></li>
               <li class="no-mnu"><a href="<?php echo base_url() .  $this->storename .'/'.$segsments[2].'/user/login';?>">Login</a></li>  
               <?php } ?> 
  ...
  <span class="mobile-txt">Menu</span>
    ...
    <ul class="clearfix">
              ...
              <?php 
               ...
               <li><a href="<?php echo base_url() .  $this->storename.'/'.$consultantDetail; ?>/contact">Contact Us</a></li>
             <li class="no-sp"><a href="<?php echo base_url() .  $this->storename .'/'.$consultantDetail. '/user/login';?>">Login</a></li>    
...
if((count($arrd) > 3) && (!in_array($arrd[3] ,array('/','home','news')))){ ?>
