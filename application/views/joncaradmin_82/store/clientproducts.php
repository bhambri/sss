        ...
        <div class="con-inner">
            <div class="inner-txt">
              ...
              <h2>Categories</h2>
                    ...
                    <!-- plan -->
                    <div id="toggle-view">
                      <ul><li><h5><a href="<?php echo base_url().$this->storename.'/'.$conSeg; ?>/store">All</a></h5></li>
                      <?php  
                                ...
                                <div class="panel">
                                  <?php 
                                    if( isset( $categories['subcategory'] ) && !empty( $categories['subcategory'] ) )
                                    {
                                       ...
                                       {                                    
                                       ?>          
                                        <a href="<?php echo base_url().$this->storename.'/'.$conSeg; ?>/store/cat_id/<?php echo $categories['id'].'/'.$subcategory->id;?>"<?php if(strtolower($this->uri->uri_string) == strtolower($this->storename.'/'.$conSeg.'/store/cat_id/'.$categories['id'].'/'.$subcategory->id )){ echo ' class=menuselected '; $selCategory = $categories['name']; $selsubCategory = $subcategory->name ;} ?> > <?php echo $subcategory->name;?></a>
                                    <?php 
                                        }  
                                    }
                                  ?>
            ...
            // $image = site_url().$product->image;
                ...
                <div class="product <?php echo $class;?>">
                  ...
                  <span class="price"> $<?php  echo $product->product_price ?></span>
                    <div class="showdiv"><span class="buy">                  
<span class="cart"> <a href="javascript:void(0);"  onclick="addtocart('<?php echo base_url() .  $this->storename.'/'.$conSeg ; ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/cart-ico.png')?>" alt=""/> Add To Cart</a></span>
                  
    <span class="wish"><a href="javascript:void(0);" onclick="addtowishlist('<?php echo base_url() .  $this->storename.'/'.$conSeg ; ?>' ,'<?php echo $product->id; ?>');"><img src="<?php echo store_fallback_path('store/images/wishlist-ico1.png')?>" alt=""/> Add To Wishlist</a></span>
                     <span class="quick"><a href="<?php echo base_url() .  $this->storename.'/'.$conSeg ; ?>/store/productDetail/<?php echo $product->id; ?>">
