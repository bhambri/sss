...
<div class="inner-banner">
  ...
  <h2>Forgot Password</h2>
	   ...
	   <div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segment(1).'/home'?>">Home </a> / Forgot Password</div>
</div>
<!--banner-->
<div class="con">
    <div class="con-inner">
    ...
    <div class="lft-form">
		    <?php echo form_open($this->uri->segment(1).'/user/forgot_password',array('id'=>'forgotPassword','name'=>'forgotPassword'));?>     
			<div class="form">
				<div class="fld">
