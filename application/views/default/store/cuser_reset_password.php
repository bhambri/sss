 ...
 <h2>Reset Password</h2>
  	   ...
  	   <div class="breadcrumb"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/home'?>">Home</a> / Reset Password</div>
 </div>	
 <!--banner-->
	<div class="con">
 	<div class="con-inner">
        <div class="inner-txt">
		    ...
		    <?php echo form_open($this->uri->segment(1).'/'.$this->uri->segment(2).'/user/reset_password',array('id'=>'resetPassword','name'=>'resetPassword'));?>     
			<div class="form">
				<div class="fld">
				...
				<div class="fld">
					<input type="hidden" name="user_id" value="<?php echo base64_decode(trim($this->uri->segment(5))); ?>" />
