...
<div class="inner-banner">
 ...
 <h2>cart</h2>
  ...
  <div class="breadcrumb"><a href="<?php echo base_url() .$this->uri->segments[1].'/home'?>">Home </a>/ Cart</div>
</div>
<!--banner-->
    ...
    <div class="inner-txt">
      ...
      ?>
	   ...
	   <div class="right-details">
   	  ...
   	  <span class="price"><span class="off">
         &nbsp; Base price :<strong>$<?php echo $this->cart->format_number($currentCart['options']['unit_price']); ?></strong> |
         &nbsp; Unit Price :<strong>$<?php echo $this->cart->format_number($currentCart['price']); ?></strong> |
      <?php echo 'Quantity: ' . $currentCart['qty']; ?>
        ...
        <div class="sizes cart-page-option">
   	      <span class="size-qty text-bold">Size <?php echo $currentCart['options']['size'] ; ?></span> <!-- <span class="code">CODE : 257058</span>  -->
   	    </div> 
        <?php } ?>
        ...
        <div class="sizes cart-page-option">
          ...
          ?>
          <?php if(!$required){ ?><a href="<?php echo base_url().$this->uri->segments[1].'/cart/removeopt/'.$key.'/'.$currentCart['rowid'] ;?>">Remove</a> | <?php } ?>
          <?php
           // echo $value ;
            }
          }
          ...
          <!-- <span class="size-qty text-bold">Size </span>text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment,text :comment, -->
           ...
           <div class="remove">                              
            <a id="removeItem" href="<?php echo site_url() . $this->storename.'/cart/removeitem/'.$currentCart['rowid'] ; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img src="<?php echo store_fallback_path('store/images/remove.png')?>" alt="" title="Remove from bag" class="vtip"/></a>
           </div> 
    ...
    <div class="order-total-summary"> 
            ...
            <!-- <input type="hidden" name="tax" id="tax" value="<?php echo $tax; ?>"> -->
               ...
               <div class="placeorder">
                  <div class="continue-btn"><a href="<?php echo site_url() . $this->storename; ?>/store/" class="btn"> Continue Shopping</a></div>
                  <form action="<?php echo site_url() . $this->storename; ?>/cart/checkout" method="get"> 
