...
$product_url = site_url().$segs[1].'/'.$segs[2].'/'.$segs[3].'/'.$segs[4].'/'.$segs[5] ;
?>
<!--banner-->
    <div class="inner-banner">
        <div class="inner-banner-main">
         ...
         <div class="breadcrumb"><a href="<?php echo base_url() .$this->uri->segments[1].'/'.$this->uri->segments[2].'/store'?>">Home </a> / Products Details</div>       
    </div>
    <!--banner-->
     <div class="con">
        <div class="con-inner">
        <?php if(!empty($product_detail)){ ?>
            <div class="inner-txt">
               <div class="singleproduct">
                ...
                <div id="gallery_09">
                  <a href="#" class="elevatezoom-gallery active" data-update="" data-image="<?php echo $image;?>" data-zoom-image="<?php echo $full_image;?>"><img src="<?php echo $image; ?>" height="80"></a>
                  <?php if($imgtwo){ ?>
                ...
                <?php $sizeArr = explode(',',$product_detail['product_size']) ;
                      #pr($sizeArr) ; ?>
                <form action="<?php echo site_url() . $this->storename.'/'.$conSeg ;?>/cart/add" method="POST" id="formID">  
                 <?php if($sizeArr[0] !="" ){ ?>
                 <div class="size">
                   <div class="selectimg">
                   <select name="size">
                ...
                <input type="hidden" name="baseurl" id="baseurl" value="<?php echo site_url() . $this->storename.'/'.$conSeg ; ?>">
