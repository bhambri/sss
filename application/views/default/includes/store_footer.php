...
//pr($this) ;
			...
			?>
			<li><a href="<?php echo $this->store_opportunity_link ? $this->store_opportunity_link : base_url().$this->storename.'/home#' ; ?>" target="_blank">Opportunities</a></li>
...
<div class="payment-strip"><a href="#"><img src="<?php echo store_fallback_path('store/images/ico-payment.png')?>" alt=""/></a></div>
		...
		<div class="copy">Copyright &copy; <?php echo date('Y') ; ?> simplesalessystems.com. All rights reserved. &nbsp; | &nbsp; <!-- <a href="privacy.php">Privacy Policy</a>  &nbsp;  | --> &nbsp;  <a href="<?php echo base_url().$this->storename.'/t_n_c' ?>" target="_blank" >Terms of use</a></div>
		<div class="social">
		<?php 
                 ...
                 <h2>Choose your membership type</h2>
                  ...
                  <div class="register-consultant"> 
                     <h3>Register as a <?php echo $this->consultant_label ;?></h3>                	
                  	...
                  	<div class="btn"><a href="<?php echo base_url() .  $this->storename; ?>/user/consultant"><input type="button" value="Sign up today" src=""></a></div>
